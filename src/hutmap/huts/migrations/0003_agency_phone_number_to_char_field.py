...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'huts_agency', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Agency.phone'
        db.alter_column(u'huts_agency', 'phone', self.gf('django.db.models.fields.BigIntegerField')(null=True))

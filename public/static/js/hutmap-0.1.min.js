...
var g=!1,f=!1,h=!1;c.hasOwnProperty("gmCenter")&&(g=!0);c.hasOwnProperty("gmZoom")&&(f=!0);c.hasOwnProperty("gmBounds")&&(h=!0);d=function(){a(function(){(g||f||h)&&b.$apply(function(){if(g&&(b.gmCenter=e.center),f&&(b.gmZoom=e.zoom),h){var a=e.bounds;a&&(b.gmBounds=a)}})})};e.addMapListener("drag",d);e.addMapListener("zoom_changed",d);e.addMapListener("center_changed",d);e.addMapListener("bounds_changed",d);g&&b.$watch("gmCenter",function(a,c){a!==c&&!e.dragging&&a&&(e.center=a)},!0);f&&b.$watch("gmZoom",
function(a,c){null!=a&&!isNaN(a)&&a!==c&&(e.zoom=a)});h&&b.$watch("gmBounds",function(a,c){a!==c&&!e.dragging&&a&&(e.bounds=a)})}}}])})();
(function(){angular.module("AngularGM").directive("gmMarkers",["$log","$parse","$timeout","angulargmUtils",function(a,b,d,c){c.latLngEqual;var e=c.objToLatLng;return{restrict:"AE",priority:100,scope:{gmObjects:"&",gmGetLatLng:"&",gmMarkerOptions:"&",gmEvent:"&"},require:"^gmMap",link:function(a,c,h,k){if(!("gmObjects"in h))throw"gmObjects attribute required";if(!("gmGetLatLng"in h))throw"gmGetLatLng attribute required";var m={};angular.forEach(h,function(a,c){if(0===c.lastIndexOf("gmOn",0)){var j=
angular.lowercase(c.substring(4)),e=b(a);m[j]=e}});var j=function(c){var b=a.gmMarkerOptions(),j={};angular.forEach(c,function(c){var n=a.gmGetLatLng({object:c}),f=e(n);if(null!=f){var h=f.toUrlValue(k.precision);if(j[h]=c,!k.hasMarker(n.lat,n.lng)){h={};angular.extend(h,b,{position:f});k.addMarker(h);var q=k.getMarker(n.lat,n.lng);angular.forEach(m,function(b,j){k.addListener(q,j,function(){d(function(){b(a.$parent.$parent,{object:c,marker:q})})})})}}});var f=[];k.forEachMarker(function(a){a.getPosition().toUrlValue(k.precision)in
j||f.push(a)});angular.forEach(f,function(a){a=a.getPosition();k.removeMarker(a.lat(),a.lng())})};a.$watch("gmObjects().length",function(c,b){null!=c&&c!==b&&j(a.gmObjects())});a.$watch("gmObjects()",function(c,b){null!=c&&c!==b&&j(a.gmObjects())});a.$watch("gmEvent()",function(a,c){if(null!=a&&a!==c){var b=a.event,j=a.location,j=k.getMarker(j.lat(),j.lng());null!=j&&d(angular.bind(this,k.trigger,j,b))}});d(angular.bind(null,j,a.gmObjects()))}}}])})();
...
function(a){this.heading=a}}],link:function(b,d,c,e){var g,f;e.addGroup(b);b.isOpen=!1;c.isOpen&&(g=a(c.isOpen),f=g.assign,b.$watch(function(){return g(b.$parent)},function(a){b.isOpen=a}),b.isOpen=g?g(b.$parent):!1);b.$watch("isOpen",function(a){a&&e.closeOthers(b);f&&f(b.$parent,a)})}}}]).directive("accordionHeading",function(){return{restrict:"E",transclude:!0,template:"",replace:!0,require:"^accordionGroup",compile:function(a,b,d){return function(a,b,g,f){f.setHeading(d(a,function(){}))}}}}).directive("accordionTransclude",
...
angular.module("ui.bootstrap.buttons",[]).constant("buttonConfig",{activeClass:"active",toggleEvent:"click"}).directive("btnRadio",["buttonConfig",function(a){var b=a.activeClass||"active",d=a.toggleEvent||"click";return{require:"ngModel",link:function(a,e,g,f){var h=a.$eval(g.btnRadio);a.$watch(function(){return f.$modelValue},function(a){angular.equals(a,h)?e.addClass(b):e.removeClass(b)});e.bind(d,function(){e.hasClass(b)||a.$apply(function(){f.$setViewValue(h)})})}}}]).directive("btnCheckbox",
["buttonConfig",function(a){var b=a.activeClass||"active",d=a.toggleEvent||"click";return{require:"ngModel",link:function(a,e,g,f){var h=a.$eval(g.btnCheckboxTrue),k=a.$eval(g.btnCheckboxFalse),h=angular.isDefined(h)?h:!0,k=angular.isDefined(k)?k:!1;a.$watch(function(){return f.$modelValue},function(a){angular.equals(a,h)?e.addClass(b):e.removeClass(b)});e.bind(d,function(){a.$apply(function(){f.$setViewValue(e.hasClass(b)?k:h)})})}}}]);
angular.module("ui.bootstrap.carousel",["ui.bootstrap.transition"]).controller("CarouselController",["$scope","$timeout","$transition","$q",function(a,b,d){function c(){function e(){k?(a.next(),c()):a.pause()}h&&b.cancel(h);var j=+a.interval;!isNaN(j)&&0<=j&&(h=b(e,j))}var e=this,g=e.slides=[],f=-1,h,k;e.currentSlide=null;e.select=function(h,j){function n(){if(e.currentSlide&&angular.isString(j)&&!a.noTransition&&h.$element){h.$element.addClass(j);h.$element.attr("offsetWidth",h.$element[0].offsetWidth);
angular.forEach(g,function(a){angular.extend(a,{direction:"",entering:!1,leaving:!1,active:!1})});angular.extend(h,{direction:j,active:!0,entering:!0});angular.extend(e.currentSlide||{},{direction:j,leaving:!0});a.$currentTransition=d(h.$element,{});var b=h,n=e.currentSlide;a.$currentTransition.then(function(){l(b,n)},function(){l(b,n)})}else l(h,e.currentSlide);e.currentSlide=h;f=p;c()}function l(c,b){angular.extend(c,{direction:"",active:!0,leaving:!1,entering:!1});angular.extend(b||{},{direction:"",
active:!1,leaving:!1,entering:!1});a.$currentTransition=null}var p=g.indexOf(h);void 0===j&&(j=p>f?"next":"prev");h&&h!==e.currentSlide&&(a.$currentTransition?(a.$currentTransition.cancel(),b(n)):n())};e.indexOfSlide=function(a){return g.indexOf(a)};a.next=function(){return e.select(g[(f+1)%g.length],"next")};a.prev=function(){return e.select(g[0>f-1?g.length-1:f-1],"prev")};a.select=function(a){e.select(a)};a.isActive=function(a){return e.currentSlide===a};a.slides=function(){return g};a.$watch("interval",
c);a.play=function(){k||(k=!0,c())};a.pause=function(){k=!1;h&&b.cancel(h)};e.addSlide=function(c,b){c.$element=b;g.push(c);1===g.length||c.active?(e.select(g[g.length-1]),1==g.length&&a.play()):c.active=!1};e.removeSlide=function(a){var c=g.indexOf(a);g.splice(c,1);0<g.length&&a.active&&(c>=g.length?e.select(g[c-1]):e.select(g[c]))}}]).directive("carousel",[function(){return{restrict:"EA",transclude:!0,replace:!0,controller:"CarouselController",require:"carousel",templateUrl:"template/carousel/carousel.html",
...
angular.module("ui.bootstrap.collapse",["ui.bootstrap.transition"]).directive("collapse",["$transition",function(a){var b=function(a,c,b){c.removeClass("collapse");c.css({height:b});c.addClass("collapse")};return{link:function(d,c,e){var g,f=!0;d.$watch(function(){return c[0].scrollHeight},function(){0!==c[0].scrollHeight&&(g||(f?b(d,c,c[0].scrollHeight+"px"):b(d,c,"auto")))});d.$watch(e.collapse,function(a){a?(g=!0,f?(f=!1,b(d,c,0)):(b(d,c,c[0].scrollHeight+"px"),k({height:"0"}))):(f?(f=!1,g||b(d,
c,"auto")):k({height:c[0].scrollHeight+"px"}).then(function(){g||b(d,c,"auto")}),g=!1)});var h,k=function(b){h&&h.cancel();h=a(c,b);h.then(function(){h=void 0},function(){h=void 0});return h}}}}]);var dialogModule=angular.module("ui.bootstrap.dialog",["ui.bootstrap.transition"]);dialogModule.controller("MessageBoxController",["$scope","dialog","model",function(a,b,d){a.title=d.title;a.message=d.message;a.buttons=d.buttons;a.close=function(a){b.close(a)}}]);
dialogModule.provider("$dialog",function(){var a={backdrop:!0,dialogClass:"modal",backdropClass:"modal-backdrop",transitionClass:"fade",triggerClass:"in",dialogOpenClass:"modal-open",resolve:{},backdropFade:!1,dialogFade:!1,keyboard:!0,backdropClick:!0},b={},d=0;this.options=function(a){b=a};this.$get=["$http","$document","$compile","$rootScope","$controller","$templateCache","$q","$transition","$injector",function(c,e,g,f,h,k,m,j,n){function l(a){var c=angular.element("<div>");c.addClass(a);return c}
function p(c){var j=this;c=this.options=angular.extend({},a,b,c);this.backdropEl=l(c.backdropClass);c.backdropFade&&(this.backdropEl.addClass(c.transitionClass),this.backdropEl.removeClass(c.triggerClass));this.modalEl=l(c.dialogClass);c.dialogFade&&(this.modalEl.addClass(c.transitionClass),this.modalEl.removeClass(c.triggerClass));this.handledEscapeKey=function(a){27===a.which&&(j.close(),a.preventDefault(),j.$scope.$apply())};this.handleBackDropClick=function(a){j.close();a.preventDefault();j.$scope.$apply()}}
var q=e.find("body");p.prototype.isOpen=function(){return this._open};p.prototype.open=function(a,c){var b=this,j=this.options;a&&(j.templateUrl=a);c&&(j.controller=c);if(!j.template&&!j.templateUrl)throw Error("Dialog.open expected template or templateUrl, neither found. Use options or open method to specify them.");this._loadResolves().then(function(a){var c=a.$scope=b.$scope=a.$scope?a.$scope:f.$new();b.modalEl.html(a.$template);b.options.controller&&(a=h(b.options.controller,a),b.modalEl.contents().data("ngControllerController",
a));g(b.modalEl)(c);b._addElementsToDom();q.addClass(b.options.dialogOpenClass);setTimeout(function(){b.options.dialogFade&&b.modalEl.addClass(b.options.triggerClass);b.options.backdropFade&&b.backdropEl.addClass(b.options.triggerClass)});b._bindEvents()});this.deferred=m.defer();return this.deferred.promise};p.prototype.close=function(a){function c(a){a.removeClass(e.options.triggerClass)}function b(){e._open&&e._onCloseComplete(a)}var e=this,n=this._getFadingElements();q.removeClass(e.options.dialogOpenClass);
if(0<n.length)for(var f=n.length-1;0<=f;f--)j(n[f],c).then(b);else this._onCloseComplete(a)};p.prototype._getFadingElements=function(){var a=[];this.options.dialogFade&&a.push(this.modalEl);this.options.backdropFade&&a.push(this.backdropEl);return a};p.prototype._bindEvents=function(){this.options.keyboard&&q.bind("keydown",this.handledEscapeKey);this.options.backdrop&&this.options.backdropClick&&this.backdropEl.bind("click",this.handleBackDropClick)};p.prototype._unbindEvents=function(){this.options.keyboard&&
...
(d--,0===d&&this.backdropEl.remove());this._open=!1};p.prototype._loadResolves=function(){var a=[],b=[],j,e=this;this.options.template?j=m.when(this.options.template):this.options.templateUrl&&(j=c.get(this.options.templateUrl,{cache:k}).then(function(a){return a.data}));angular.forEach(this.options.resolve||[],function(c,j){b.push(j);a.push(angular.isString(c)?n.get(c):n.invoke(c))});b.push("$template");a.push(j);return m.all(a).then(function(a){var c={};angular.forEach(a,function(a,j){c[b[j]]=a});
...
angular.module("ui.bootstrap.dropdownToggle",[]).directive("dropdownToggle",["$document","$location","$window",function(a,b){var d=null,c;return{restrict:"CA",link:function(e,g){e.$watch(function(){return b.path()},function(){c&&c()});g.parent().bind("click",function(){c&&c()});g.bind("click",function(b){b.preventDefault();b.stopPropagation();b=!1;d&&(b=d===g,c());b||(g.parent().addClass("open"),d=g,c=function(b){b&&(b.preventDefault(),b.stopPropagation());a.unbind("click",c);g.parent().removeClass("open");
d=c=null},a.bind("click",c))})}}}]);
angular.module("ui.bootstrap.modal",["ui.bootstrap.dialog"]).directive("modal",["$parse","$dialog",function(a,b){return{restrict:"EA",terminal:!0,link:function(d,c,e){var g=angular.extend({},d.$eval(e.uiOptions||e.bsOptions||e.options)),f=e.modal||e.show,h,g=angular.extend(g,{template:c.html(),resolve:{$scope:function(){return d}}}),k=b.dialog(g);c.remove();h=e.close?function(){a(e.close)(d)}:function(){angular.isFunction(a(f).assign)&&a(f).assign(d,!1)};d.$watch(f,function(a){a?k.open().then(function(){h()}):
k.isOpen()&&k.close()})}}}]);
angular.module("ui.bootstrap.pagination",[]).constant("paginationConfig",{boundaryLinks:!1,directionLinks:!0,firstText:"First",previousText:"Previous",nextText:"Next",lastText:"Last"}).directive("pagination",["paginationConfig",function(a){return{restrict:"EA",scope:{numPages:"=",currentPage:"=",maxSize:"=",onSelectPage:"&"},templateUrl:"template/pagination/pagination.html",replace:!0,link:function(b,d,c){function e(a,c,b,j){return{number:a,text:c,active:b,disabled:j}}var g=angular.isDefined(c.boundaryLinks)?
b.$eval(c.boundaryLinks):a.boundaryLinks,f=angular.isDefined(c.directionLinks)?b.$eval(c.directionLinks):a.directionLinks,h=angular.isDefined(c.firstText)?c.firstText:a.firstText,k=angular.isDefined(c.previousText)?c.previousText:a.previousText,m=angular.isDefined(c.nextText)?c.nextText:a.nextText,j=angular.isDefined(c.lastText)?c.lastText:a.lastText;b.$watch("numPages + currentPage + maxSize",function(){b.pages=[];var a=b.maxSize&&b.maxSize<b.numPages?b.maxSize:b.numPages,c=b.currentPage-Math.floor(a/
2);1>c&&(c=1);c+a-1>b.numPages&&(c-=c+a-1-b.numPages);for(var d=c,a=c+a;d<a;d++)c=e(d,d,b.isActive(d),!1),b.pages.push(c);f&&(d=e(b.currentPage-1,k,!1,b.noPrevious()),b.pages.unshift(d),d=e(b.currentPage+1,m,!1,b.noNext()),b.pages.push(d));g&&(d=e(1,h,!1,b.noPrevious()),b.pages.unshift(d),d=e(b.numPages,j,!1,b.noNext()),b.pages.push(d));b.currentPage>b.numPages&&b.selectPage(b.numPages)});b.noPrevious=function(){return 1===b.currentPage};b.noNext=function(){return b.currentPage===b.numPages};b.isActive=
...
replace:!0}}).directive("pane",["$parse",function(a){return{require:"^tabs",restrict:"EA",transclude:!0,scope:{heading:"@"},link:function(b,d,c,e){var g,f;b.selected=!1;c.active&&(g=a(c.active),f=g.assign,b.$watch(function(){return g(b.$parent)},function(a){b.selected=a}),b.selected=g?g(b.$parent):!1);b.$watch("selected",function(a){a&&e.select(b);f&&f(b.$parent,a)});e.addPane(b);b.$on("$destroy",function(){e.removePane(b)})},templateUrl:"template/tabs/pane.html",replace:!0}}]);
angular.module("ui.bootstrap.tooltip",[]).provider("$tooltip",function(){var a={placement:"top",animation:!0},b={};this.options=function(a){angular.extend(b,a)};this.$get=["$window","$compile","$timeout","$parse",function(d,c,e,g){return function(f,h,k){var m=angular.extend({},a,b),j="<"+f+'-popup title="{{tt_title}}" content="{{tt_content}}" placement="{{tt_placement}}" animation="tt_animation()" is-open="tt_isOpen"></'+f+"-popup>";return{restrict:"EA",scope:!0,link:function(a,b,p){function q(){var c,
...
a.tt_isOpen=!0}}function t(){a.tt_isOpen=!1;angular.isDefined(a.tt_animation)&&a.tt_animation()?s=e(function(){r.remove()},500):r.remove()}var r=c(j)(a),s;p.$observe(f,function(c){a.tt_content=c});p.$observe(f+"Title",function(c){a.tt_title=c});p.$observe(f+"Placement",function(c){a.tt_placement=angular.isDefined(c)?c:m.placement});p.$observe(f+"Animation",function(c){a.tt_animation=angular.isDefined(c)?g(c):function(){return m.animation}});a.tt_isOpen=!1;angular.isDefined(k)?(b.bind(h,function(){a.$apply(q)}),
b.bind(k,function(){a.$apply(t)})):b.bind(h,function(){a.tt_isOpen?a.$apply(t):a.$apply(q)})}}}}]}).directive("tooltipPopup",function(){return{restrict:"E",replace:!0,scope:{content:"@",placement:"@",animation:"&",isOpen:"&"},templateUrl:"template/tooltip/tooltip-popup.html"}}).directive("tooltip",["$tooltip",function(a){return a("tooltip","mouseenter","mouseleave")}]);
angular.module("ui.bootstrap.transition",[]).factory("$transition",["$q","$timeout","$rootScope",function(a,b,d){function c(a){for(var c in a)if(void 0!==g.style[c])return a[c]}var e=function(c,g,k){k=k||{};var m=a.defer(),j=e[k.animation?"animationEndEventName":"transitionEndEventName"],n=function(){d.$apply(function(){c.unbind(j,n);m.resolve(c)})};j&&c.bind(j,n);b(function(){angular.isString(g)?c.addClass(g):angular.isFunction(g)?g(c):angular.isObject(g)&&c.css(g);j||m.resolve(c)});m.promise.cancel=
function(){j&&c.unbind(j,n);m.reject("Transition cancelled")};return m.promise},g=document.createElement("trans");e.transitionEndEventName=c({WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",msTransition:"MSTransitionEnd",transition:"transitionend"});e.animationEndEventName=c({WebkitTransition:"webkitAnimationEnd",MozTransition:"animationend",OTransition:"oAnimationEnd",msTransition:"MSAnimationEnd",transition:"animationend"});return e}]);
...
function(a,b,d,c){var e=[9,13,27,38,40];return{require:"ngModel",link:function(g,f,h,k){var m=k.$modelValue,j=g.$eval(h.typeaheadMinLength)||1,n=c.parse(h.typeahead),l=g.$new();g.$on("$destroy",function(){l.$destroy()});var p=function(){l.matches=[];l.activeIdx=-1};p();l.query=void 0;k.$parsers.push(function(a){p();if(m)return a;if(a&&a.length>=j){var c={$viewValue:a};b.when(n.source(l,c)).then(function(b){if(a===k.$viewValue)if(0<b.length){l.activeIdx=0;for(var j=l.matches.length=0;j<b.length;j++)c[n.itemName]=
b[j],l.matches.push({label:n.viewMapper(l,c),model:b[j]});l.query=a}else p()},p)}});k.$render=function(){var a={};a[n.itemName]=m;f.val(n.viewMapper(l,a)||k.$viewValue);m=void 0};l.select=function(a){var c={};c[n.itemName]=m=l.matches[a].model;k.$setViewValue(n.modelMapper(l,c));k.$render()};f.bind("keydown",function(a){0===l.matches.length||-1===e.indexOf(a.which)||(a.preventDefault(),40===a.which?(l.activeIdx=(l.activeIdx+1)%l.matches.length,l.$digest()):38===a.which?(l.activeIdx=(l.activeIdx?l.activeIdx:
l.matches.length)-1,l.$digest()):13===a.which||9===a.which?l.$apply(function(){l.select(l.activeIdx)}):27===a.which&&(a.stopPropagation(),l.matches=[],l.$digest()))});d.find("body").bind("click",function(){l.matches=[];l.$digest()});g=a("<typeahead-popup matches='matches' active='activeIdx' select='select(activeIdx)' query='query'></typeahead-popup>")(l);f.after(g)}}}]).directive("typeaheadPopup",function(){return{restrict:"E",scope:{matches:"=",query:"=",active:"=",select:"&"},replace:!0,templateUrl:"template/typeahead/typeahead.html",
...
b.hide()},b.options.delay.hide)},show:function(){var c,b,d,f,h;b=a.Event("show");if(this.hasContent()&&this.enabled&&(this.$element.trigger(b),!b.isDefaultPrevented())){c=this.tip();this.setContent();this.options.animation&&c.addClass("fade");f="function"==typeof this.options.placement?this.options.placement.call(this,c[0],this.$element[0]):this.options.placement;c.detach().css({top:0,left:0,display:"block"});this.options.container?c.appendTo(this.options.container):c.insertAfter(this.$element);b=
this.getPosition();d=c[0].offsetWidth;c=c[0].offsetHeight;switch(f){case "bottom":h={top:b.top+b.height,left:b.left+b.width/2-d/2};break;case "top":h={top:b.top-c,left:b.left+b.width/2-d/2};break;case "left":h={top:b.top+b.height/2-c/2,left:b.left-d};break;case "right":h={top:b.top+b.height/2-c/2,left:b.left+b.width}}this.applyPlacement(h,f);this.$element.trigger("shown")}},applyPlacement:function(a,b){var d=this.tip(),f=d[0].offsetWidth,h=d[0].offsetHeight,k,m,j;d.offset(a).addClass(b).addClass("in");
k=d[0].offsetWidth;m=d[0].offsetHeight;"top"==b&&m!=h&&(a.top=a.top+h-m,j=!0);"bottom"==b||"top"==b?(h=0,0>a.left&&(h=-2*a.left,a.left=0,d.offset(a),k=d[0].offsetWidth),this.replaceArrow(h-f+k,k,"left")):this.replaceArrow(m-h,m,"top");j&&d.offset(a)},replaceArrow:function(a,b,d){this.arrow().css(d,a?50*(1-a/b)+"%":"")},setContent:function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")},hide:function(){var c=
this.tip(),b=a.Event("hide");this.$element.trigger(b);if(!b.isDefaultPrevented()){c.removeClass("in");if(a.support.transition&&this.$tip.hasClass("fade")){var d=setTimeout(function(){c.off(a.support.transition.end).detach()},500);c.one(a.support.transition.end,function(){clearTimeout(d);c.detach()})}else c.detach();this.$element.trigger("hidden");return this}},fixTitle:function(){var a=this.$element;if(a.attr("title")||"string"!=typeof a.attr("data-original-title"))a.attr("data-original-title",a.attr("title")||
...
d.left=parseInt(a.style["border-left-width"],10)||0;d.right=parseInt(a.style["border-right-width"],10)||0;return d},c=0,e=0,g=function(){c="undefined"!==typeof document.documentElement.scrollLeft?document.documentElement.scrollLeft:document.body.scrollLeft;e="undefined"!==typeof document.documentElement.scrollTop?document.documentElement.scrollTop:document.body.scrollTop};g();var f=function(a){var b=0,d=0;a=a||window.event;"undefined"!==typeof a.pageX?(b=a.pageX,d=a.pageY):"undefined"!==typeof a.clientX&&
(b=a.clientX+c,d=a.clientY+e);return{left:b,top:d}},h=function(a){var b=a.offsetLeft,c=a.offsetTop;for(a=a.offsetParent;null!==a;){a!==document.body&&a!==document.documentElement&&(b-=a.scrollLeft,c-=a.scrollTop);var d=a,f=d.offsetLeft,e=d.offsetTop;if(!f&&!e&&window.getComputedStyle&&(d=document.defaultView.getComputedStyle(d,null).MozTransform||document.defaultView.getComputedStyle(d,null).WebkitTransform)&&"string"===typeof d)d=d.split(","),f+=parseInt(d[4],10)||0,e+=parseInt(d[5],10)||0;b+=f;
c+=e;a=a.offsetParent}return{left:b,top:c}},k=function(a,b){if(a&&b)for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a},m=function(a,b){"undefined"!==typeof b&&(a.style.opacity=b);"undefined"!==typeof a.style.opacity&&""!==a.style.opacity&&(a.style.filter="alpha(opacity="+100*a.style.opacity+")")};a.prototype.init_=function(a,b){var c,f=this;this.map_=a;b=b||{};this.key_=b.key||"shift";this.key_=this.key_.toLowerCase();this.borderWidths_=d(this.map_.getDiv());this.veilDiv_=[];for(c=0;4>c;c++)this.veilDiv_[c]=
...
this.listeners_=[google.maps.event.addDomListener(document,"keydown",function(a){f.onKeyDown_(a)}),google.maps.event.addDomListener(document,"keyup",function(a){f.onKeyUp_(a)}),google.maps.event.addDomListener(this.veilDiv_[0],"mousedown",function(a){f.onMouseDown_(a)}),google.maps.event.addDomListener(this.veilDiv_[1],"mousedown",function(a){f.onMouseDown_(a)}),google.maps.event.addDomListener(this.veilDiv_[2],"mousedown",function(a){f.onMouseDown_(a)}),google.maps.event.addDomListener(this.veilDiv_[3],
"mousedown",function(a){f.onMouseDown_(a)}),google.maps.event.addDomListener(document,"mousedown",function(a){f.onMouseDownDocument_(a)}),google.maps.event.addDomListener(document,"mousemove",function(a){f.onMouseMove_(a)}),google.maps.event.addDomListener(document,"mouseup",function(a){f.onMouseUp_(a)}),google.maps.event.addDomListener(window,"scroll",g)];this.dragging_=this.mouseDown_=this.hotKeyDown_=!1;this.mapPosn_=this.mousePosn_=this.mapHeight_=this.mapWidth_=this.endPt_=this.startPt_=null;
...
!0};a.prototype.onMouseMove_=function(a){this.mousePosn_=f(a);if(this.dragging_){this.endPt_=this.getMousePoint_(a);a=Math.min(this.startPt_.x,this.endPt_.x);var b=Math.min(this.startPt_.y,this.endPt_.y),c=Math.abs(this.startPt_.x-this.endPt_.x),d=Math.abs(this.startPt_.y-this.endPt_.y),e=Math.max(0,c-(this.boxBorderWidths_.left+this.boxBorderWidths_.right)),g=Math.max(0,d-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom));this.veilDiv_[0].style.top="0px";this.veilDiv_[0].style.left="0px";
...
c+"px";this.veilDiv_[3].style.height=this.mapHeight_-(b+d)+"px";this.boxDiv_.style.top=b+"px";this.boxDiv_.style.left=a+"px";this.boxDiv_.style.width=e+"px";this.boxDiv_.style.height=g+"px";this.boxDiv_.style.display="block";google.maps.event.trigger(this,"drag",new google.maps.Point(a,b+d),new google.maps.Point(a+c,b),this.prjov_.getProjection())}else this.mouseDown_||(this.mapPosn_=h(this.map_.getDiv()),this.setVeilVisibility_())};a.prototype.onMouseUp_=function(a){var b,c=this;this.mouseDown_=
!1;if(this.dragging_)if(this.getMousePoint_(a).x===this.startPt_.x&&this.getMousePoint_(a).y===this.startPt_.y)this.onKeyUp_(a);else{var d=Math.min(this.startPt_.x,this.endPt_.x),f=Math.min(this.startPt_.y,this.endPt_.y);b=Math.abs(this.startPt_.x-this.endPt_.x);var e=Math.abs(this.startPt_.y-this.endPt_.y),d=d+this.borderWidths_.left,f=f+this.borderWidths_.top,g=this.prjov_.getProjection(),e=g.fromContainerPixelToLatLng(new google.maps.Point(d,f+e)),f=g.fromContainerPixelToLatLng(new google.maps.Point(d+
b,f)),d=new google.maps.LatLngBounds(e,f);this.noZoom_?this.boxDiv_.style.display="none":(b=this.map_.getZoom(),this.map_.fitBounds(d),this.map_.getZoom()<b&&this.map_.setZoom(b),e=g.fromLatLngToContainerPixel(e),g=g.fromLatLngToContainerPixel(f),e.x-=this.borderWidths_.left,e.y-=this.borderWidths_.top,g.x-=this.borderWidths_.left,g.y-=this.borderWidths_.top,this.boxDiv_.style.left=e.x+"px",this.boxDiv_.style.top=g.y+"px",this.boxDiv_.style.width=Math.abs(g.x-e.x)-(this.boxBorderWidths_.left+this.boxBorderWidths_.right)+
"px",this.boxDiv_.style.height=Math.abs(g.y-e.y)-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom)+"px",setTimeout(function(){c.boxDiv_.style.display="none"},1E3));this.dragging_=!1;this.onMouseMove_(a);google.maps.event.trigger(this,"dragend",d);if(!this.isHotKeyDown_(a))this.onKeyUp_(a)}};a.prototype.onKeyUp_=function(){var a,b,c,d,f;b=null;if(this.map_&&this.hotKeyDown_){this.hotKeyDown_=!1;this.dragging_&&(this.boxDiv_.style.display="none",this.dragging_=!1,a=Math.min(this.startPt_.x,this.endPt_.x),
b=Math.min(this.startPt_.y,this.endPt_.y),c=Math.abs(this.startPt_.x-this.endPt_.x),d=Math.abs(this.startPt_.y-this.endPt_.y),f=this.prjov_.getProjection(),d=f.fromContainerPixelToLatLng(new google.maps.Point(a,b+d)),a=f.fromContainerPixelToLatLng(new google.maps.Point(a+c,b)),b=new google.maps.LatLngBounds(d,a));for(a=0;a<this.veilDiv_.length;a++)this.veilDiv_[a].style.display="none";this.visualEnabled_&&(this.buttonDiv_.firstChild.style.left=-(2*this.visualSize_.width)+"px",this.buttonDiv_.title=
...
b.prjov_.setMap(null);this.dragZoom_=null}};google.maps.Map.prototype.keyDragZoomEnabled=function(){return null!==this.dragZoom_};google.maps.Map.prototype.getDragZoomObject=function(){return this.dragZoom_}})();(function(){angular.module("hutmap","hutmapServices hutmapFilters AngularGM ngResource $strap.directives ui.bootstrap".split(" "))})();(function(){angular.module("hutmapServices",[]).factory("Huts",["$resource",function(a){return a("/huts/api/v1/hut",{},{query:{method:"GET",params:{}}})}]).factory("Places",["$q",function(a){function b(a,b,c){c==google.maps.places.PlacesServiceStatus.OK?a.resolve(b):a.reject(c)}var d=angular.element('<div id="google-attributions"></div>'),c=new google.maps.places.PlacesService(d[0]),e=new google.maps.places.AutocompleteService;return{getDetails:function(d){var f=a.defer();c.getDetails({reference:d},
angular.bind(this,b,f));return f.promise},textSearch:function(d){var f=a.defer();c.textSearch(d,angular.bind(this,b,f));return f.promise},getPlacePredictions:function(c){var d=a.defer();e.getPlacePredictions({input:c},angular.bind(this,b,d));return d.promise}}}]).factory("utils",[function(){return{latLngFromUrlValue:function(a){a=a.split(",");return new google.maps.LatLng(a[0],a[1])}}}])})();(function(){angular.module("hutmap").config(["$routeProvider","$locationProvider",function(a,b){a.when("/",{templateUrl:"/partials/home.html",activetab:"home"}).when("/map/",{templateUrl:"/partials/map.html",activetab:"map",reloadOnSearch:!1}).when("/about/",{templateUrl:"/partials/about.html",activetab:"about"});b.html5Mode(!0)}]).constant("hutmapMapId","map_canvas").value("mapOptions",{zoom:3,center:new google.maps.LatLng(46.87916,-120),mapTypeId:google.maps.MapTypeId.ROADMAP,streetViewControl:!1}).value("markerOptions",
{huts:{icon:"/static/img/marker_gray_small.png",shape:{coord:[6,0,2,2,0,6,6,13,12,6,10,2,6,0],type:"poly"},zIndex:0},selected:{icon:"/static/img/marker_blue.png",zIndex:1}})})();(function(){angular.module("hutmapFilters",[]).filter("truncate",function(){return function(a,b,d){isNaN(b)&&(b=10);void 0===d&&(d="...");return null==a||0==a.length?null:a.length<=b||a.length-d.length<=b?a:String(a).substring(0,b-d.length)+d}})})();(function(){angular.module("hutmap.directives",[])})();(function(){angular.module("hutmap").controller("HutCtrl",["$scope","$location","Huts",function(a,b,d){a.huts;a.hutsMeta;a.query;a.selectedHut;a.setQuery=function(b){a.query=b};a.setSelectedHut=function(b){a.selectedHut=b};a.$watch("query",function(c){if(null!=c){if(c){a.setLoading(!0);var e=d.query(c,function(){a.huts=e.objects;a.hutsMeta=e.meta;a.setLoading(!1)},function(){a.setLoading(!1)})}c&&angular.forEach(c,function(a,c){b.search("h_"+c,a)})}});a.$watch("hutsMeta.total_count",function(a){a&&
console.log(a)});var c=b.search(),e={},g=!1;angular.forEach(c,function(a,b){0===b.lastIndexOf("h_",0)&&(b=b.substring(2),e[b]=a,g=!0)});g&&(a.query=e)}])})();(function(){angular.module("hutmap").controller("HutmapCtrl",["$scope","$route","$location","$timeout","$log","angulargmContainer",function(a,b){a.$route=b;a.loading=!1;a.setLoading=function(b){a.loading=b};a.alerts=[{type:"error",msg:"Oh snap! Change a few things up and try submitting again."},{type:"success",msg:"Well done! You successfully read this important alert message."}];a.addAlert=function(b){a.alerts.push(b)};a.closeAlert=function(b){a.alerts.splice(b,1)}}]).controller("CarouselCtrl",["$scope",
"$route",function(a){a.carouselInterval=6E3;a.slides=[{title:"Big Hut",text:"lorem ipsum dolor",image:"https://mail-attachment.googleusercontent.com/attachment/u/0/?ui=2&ik=8768b5ed5b&view=att&th=13ba670d57d0c5f1&attid=0.3&disp=inline&realattid=f_haswzj3n2&safe=1&zw&saduie=AG9B_P9lJiRTwBR09D1jE4IKml8C&sadet=1363715869360&sads=7jqjo-uAUQ2mWgLwJ-5zPIGflA0"},{title:"Joe River Chickee",text:"lorem ipsum dolor",image:"https://mail-attachment.googleusercontent.com/attachment/u/0/?ui=2&ik=8768b5ed5b&view=att&th=13ba670d57d0c5f1&attid=0.5&disp=inline&realattid=f_haswzj3u4&safe=1&zw&saduie=AG9B_P9lJiRTwBR09D1jE4IKml8C&sadet=1363715863132&sads=kmhkET9W_d5-f6HLhAIZpt5kx2U"},
{title:"John Muir Shelter",text:"lorem ipsum dolor",image:"https://mail-attachment.googleusercontent.com/attachment/u/0/?ui=2&ik=8768b5ed5b&view=att&th=13ba670d57d0c5f1&attid=0.6&disp=inline&realattid=f_haswzj3v5&safe=1&zw&saduie=AG9B_P9lJiRTwBR09D1jE4IKml8C&sadet=1363715851827&sads=yGOzj2H_sDdau-G_UX0F2mW-MrE&sadssc=1"}]}]).controller("HutInfoCtrl",["$scope",function(a){a.accuracy_tooltip="Coordinates provided, but unverifiable.;Wild ass guess.;Slightly better than a wild ass guess.;Found structure on satellite or topo map.;Surveyed with GPS by the Hutmap team.;Found on a map and surveyed by the Hutmap team.".split(";")}])})();(function(){angular.module("hutmap").controller("SearchCtrl",["$scope","$location","$route","$log","Places",function(a,b,d,c,e){a.submitting=!1;a.lastQuery;a.selected;a.getPlaces=function(b){return(a.lastQuery=b)&&!a.submitting?e.getPlacePredictions(b).then(function(b){return a.submitting?[]:b},function(){return[]}):[]};var g=function(b){a.submitting=!1;c.error(b);a.addAlert({type:"error",msg:"There was an error retrieving search results. TODO: better messages"})},f=function(c){a.submitting=!1;d.reload();
b.path("/map/").search("m_selected",null).search("m_center",c.geometry.location.toUrlValue()).search("m_zoom",8);c.geometry.viewport&&b.search("h_bbox",c.geometry.viewport.toUrlValue())};a.$watch("selected",function(b){b&&a.submit()});a.submit=function(){if(a.selected){a.submitting=!0;var b=a.selected;b.reference&&e.getDetails(b.reference).then(function(a){f(a)},g)}else if(b=a.lastQuery)a.submitting=!0,e.getPlacePredictions(b).then(function(a){e.getDetails(a[0].reference).then(function(a){f(a)},g)},
g)}}])})();(function(){angular.module("hutmap").controller("MapCtrl",["$scope","$location","$timeout","$q","angulargmContainer","hutmapMapId","mapOptions","markerOptions","utils",function(a,b,d,c,e,g,f,h,k){d=e.getMapPromise(g);var m=c.defer(),j=c.defer();a.hutmapMapId=g;a.mapOptions=f;a.markerOptions=h;a.center;a.zoom;a.bounds;a.hutMarkerEvent;c=function(c,d){if(c!==d&&(a.center&&b.search("m_center",a.center.toUrlValue()),a.zoom&&b.search("m_zoom",a.zoom),a.selectedHut)){var e=a.selectedHut.location;b.search("m_selected",
e.lat+","+e.lng)}};a.$watch("center != null && zoom != null",function(a){a&&m.resolve()});a.$watch("huts != null",function(a){a&&j.resolve()});a.$watch("center",c);a.$watch("zoom",c);a.$watch("selectedHut",c);a.selectHut=function(b,c){a.prevSelectedMarker&&a.prevSelectedMarker.setOptions(h.huts);a.prevSelectedMarker=b;b.setOptions(h.selected);a.setSelectedHut(c)};d.then(function(a){var b={MSR_TOPO:new google.maps.ImageMapType({name:"MSR USGS",alt:"USGS topos from Microsoft Research",minZoom:1,maxZoom:15,
tileSize:new google.maps.Size(256,256),isPng:!1,getTileUrl:function(b,c){var d=a.getProjection(),e=Math.pow(2,c),f=new google.maps.Point(256*b.x/e,256*(b.y+1)/e),e=new google.maps.Point(256*(b.x+1)/e,256*b.y/e),f=d.fromPointToLatLng(f),d=d.fromPointToLatLng(e);return"http://msrmaps.com/ogcmap.ashx?version=1.1.1&request=GetMap&Layers=drg&Styles=default&SRS=EPSG:4326&BBOX="+[f.lng(),f.lat(),d.lng(),d.lat()].join()+"&width=256&height=256&format=image/jpeg"}}),ARC_GIS_USA:new google.maps.ImageMapType({name:"ArcGIS USA",
alt:"ArcGIS USA Topos",minZoom:1,maxZoom:15,tileSize:new google.maps.Size(256,256),isPng:!0,getTileUrl:function(a,b){var c=1<<b,d=a.x%c;0>d&&(d+=c);return"http://services.arcgisonline.com/ArcGIS/rest/services/USA_Topo_Maps/MapServer/tile/"+parseInt(b)+"/"+a.y+"/"+d}}),ARC_GIS_WORLD:new google.maps.ImageMapType({name:"ArcGIS World",alt:"ArcGIS World Topos",minZoom:1,maxZoom:15,tileSize:new google.maps.Size(256,256),isPng:!0,getTileUrl:function(a,b){var c=1<<b,d=a.x%c;0>d&&(d+=c);return"http://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/"+
parseInt(b)+"/"+a.y+"/"+d}})};angular.forEach(b,function(b){a.mapTypes.set(b.name,b)});a.setOptions({mapTypeControlOptions:{mapTypeIds:[google.maps.MapTypeId.ROADMAP,google.maps.MapTypeId.SATELLITE,google.maps.MapTypeId.HYBRID,google.maps.MapTypeId.TERRAIN,b.MSR_TOPO.name,b.ARC_GIS_USA.name,b.ARC_GIS_WORLD.name]}});a.enableKeyDragZoom({key:"alt",visualEnabled:!0})});var n=b.search().m_center,l=b.search().m_zoom,p=b.search().m_selected;m.promise.then(function(){null!=n&&(a.center=k.latLngFromUrlValue(n));
null!=l&&(a.zoom=Number(l))});j.promise.then(function(){null!=p&&(a.hutMarkerEvent={event:"click",location:k.latLngFromUrlValue(p)})})}])})();

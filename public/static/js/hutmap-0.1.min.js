...
var g=!1,h=!1,f=!1;c.hasOwnProperty("gmCenter")&&(g=!0);c.hasOwnProperty("gmZoom")&&(h=!0);c.hasOwnProperty("gmBounds")&&(f=!0);e=function(){a(function(){(g||h||f)&&b.$apply(function(){if(g&&(b.gmCenter=d.center),h&&(b.gmZoom=d.zoom),f){var a=d.bounds;a&&(b.gmBounds=a)}})})};d.addMapListener("drag",e);d.addMapListener("zoom_changed",e);d.addMapListener("center_changed",e);d.addMapListener("bounds_changed",e);g&&b.$watch("gmCenter",function(a,b){a!==b&&!d.dragging&&a&&(d.center=a)},!0);h&&b.$watch("gmZoom",
...
angular.lowercase(j.substring(4)),c=b(a);l[k]=c}});var j=function(b){var j={};angular.forEach(b,function(b){var m=a.gmGetLatLng({object:b}),c=d(m);if(null!=c){var f=a.gmGetMarkerOptions({object:b}),p=c.toUrlValue(k.precision);if(j[p]=b,!k.hasMarker(m.lat,m.lng)){p={};angular.extend(p,f,{position:c});k.addMarker(p);var h=k.getMarker(m.lat,m.lng);angular.forEach(l,function(j,m){k.addListener(h,m,function(){e(function(){j(a.$parent.$parent,{object:b,marker:h})})})})}}});var c=[];k.forEachMarker(function(a){a.getPosition().toUrlValue(k.precision)in
j||c.push(a)});angular.forEach(c,function(a){a=a.getPosition();k.removeMarker(a.lat(),a.lng())})};a.$watch("gmObjects().length",function(b,c){null!=b&&b!==c&&j(a.gmObjects())});a.$watch("gmObjects()",function(b,c){null!=b&&b!==c&&j(a.gmObjects())});a.$watch("gmEvent()",function(a,b){if(null!=a&&a!==b){var j=a.event,c=a.location,c=k.getMarker(c.lat(),c.lng());null!=c&&e(angular.bind(this,k.trigger,c,j))}});e(angular.bind(null,j,a.gmObjects()))}}}])})();
...
set:function(a){if(f(a.getSouthWest())||f(a.getNorthEast()))throw"bounds contains null or NaN";!h(this.bounds,a)&&this._map.fitBounds(a)}}});this._initDragListeners();a.$on("$destroy",angular.bind(this,this._destroy,j))})(a,b)}])})();/*
 MIT License, http://www.opensource.org/licenses/MIT
*/
...
angular.lowercase(j.substring(4)),d=b(a);l[c]=d}});var j=function(b){var j={};angular.forEach(b,function(b){var c=a.gmGetLatLng({object:b}),m=d(c);if(null!=m){var f=a.gmGetMarkerOptions({object:b}),p=m.toUrlValue(k.precision);if(j[p]=b,!k.hasMarker(c.lat,c.lng)){p={};angular.extend(p,f,{position:m});k.addMarker(p);var h=k.getMarker(c.lat,c.lng);angular.forEach(l,function(j,c){k.addListener(h,c,function(){e(function(){j(a.$parent.$parent,{object:b,marker:h})})})})}}});var c=[];k.forEachMarker(function(a){a.getPosition().toUrlValue(k.precision)in
...
null,delete this._markers[c],j};this.fitToMarkers=function(){var a=new google.maps.LatLngBounds;this.forEachMarker(function(b){a.extend(b.getPosition())});this.bounds=a};this.forEachMarker=function(a){if(null==a)throw"fn was null or undefined";angular.forEach(this._markers,function(b){null!=b&&a(b)})};angular.bind(this,function(a,b){var j=a.gmMapId();if(!j)throw"angulargm must have non-empty gmMapId attribute";var m=b.find("[id]");m.attr("id",j);var e=this._getConfig(a,c);this._map=this._createMap(j,
m,e,d);this._markers={};this.dragging=!1;Object.defineProperties(this,{precision:{value:3,writeable:!1},center:{configurable:!0,get:function(){return this._map.getCenter()},set:function(a){if(f(a))throw"center contains null or NaN";!g(this.center,a)&&this._map.panTo(a)}},zoom:{configurable:!0,get:function(){return this._map.getZoom()},set:function(a){if(null==a||isNaN(a))throw"zoom was null or NaN";this.zoom!==a&&this._map.setZoom(a)}},bounds:{configurable:!0,get:function(){return this._map.getBounds()},
set:function(a){if(f(a.getSouthWest())||f(a.getNorthEast()))throw"bounds contains null or NaN";!h(this.bounds,a)&&this._map.fitBounds(a)}}});this._initDragListeners();a.$on("$destroy",angular.bind(this,this._destroy,j))})(a,b)}])})();(function(){function a(a,b){var c=this,d=new google.maps.OverlayView;d.onAdd=function(){c.init_(a,b)};d.draw=function(){};d.onRemove=function(){};d.setMap(a);this.prjov_=d}var b=function(a){switch(a){case "thin":a="2px";break;case "medium":a="4px";break;case "thick":a="6px";break}return a},e=function(a){var c,d={};if(document.defaultView&&document.defaultView.getComputedStyle){if(c=a.ownerDocument.defaultView.getComputedStyle(a,""))return d.top=parseInt(c.borderTopWidth,10)||0,d.bottom=parseInt(c.borderBottomWidth,
...
!0};a.prototype.onMouseMove_=function(a){this.mousePosn_=h(a);if(this.dragging_){this.endPt_=this.getMousePoint_(a);a=Math.min(this.startPt_.x,this.endPt_.x);var b=Math.min(this.startPt_.y,this.endPt_.y),d=Math.abs(this.startPt_.x-this.endPt_.x),c=Math.abs(this.startPt_.y-this.endPt_.y),e=Math.max(0,d-(this.boxBorderWidths_.left+this.boxBorderWidths_.right)),g=Math.max(0,c-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom));this.veilDiv_[0].style.top="0px";this.veilDiv_[0].style.left="0px";
...
!1;if(this.dragging_)if(this.getMousePoint_(a).x===this.startPt_.x&&this.getMousePoint_(a).y===this.startPt_.y)this.onKeyUp_(a);else{var c=Math.min(this.startPt_.x,this.endPt_.x),e=Math.min(this.startPt_.y,this.endPt_.y);b=Math.abs(this.startPt_.x-this.endPt_.x);var f=Math.abs(this.startPt_.y-this.endPt_.y),c=c+this.borderWidths_.left,e=e+this.borderWidths_.top,h=this.prjov_.getProjection(),f=h.fromContainerPixelToLatLng(new google.maps.Point(c,e+f)),e=h.fromContainerPixelToLatLng(new google.maps.Point(c+
...
"px",this.boxDiv_.style.height=Math.abs(h.y-f.y)-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom)+"px",setTimeout(function(){d.boxDiv_.style.display="none"},1E3));this.dragging_=!1;this.onMouseMove_(a);google.maps.event.trigger(this,"dragend",c);if(!this.isHotKeyDown_(a))this.onKeyUp_(a)}};a.prototype.onKeyUp_=function(){var a,b,d,c,e;b=null;if(this.map_&&this.hotKeyDown_){this.hotKeyDown_=!1;this.dragging_&&(this.boxDiv_.style.display="none",this.dragging_=!1,a=Math.min(this.startPt_.x,this.endPt_.x),
...
angular.module("ui.bootstrap.transition",[]).factory("$transition",["$q","$timeout","$rootScope",function(a,b,e){function c(a){for(var b in a)if(void 0!==g.style[b])return a[b]}var d=function(c,f,g){g=g||{};var l=a.defer(),j=d[g.animation?"animationEndEventName":"transitionEndEventName"],m=function(){e.$apply(function(){c.unbind(j,m);l.resolve(c)})};j&&c.bind(j,m);b(function(){angular.isString(f)?c.addClass(f):angular.isFunction(f)?f(c):angular.isObject(f)&&c.css(f);j||l.resolve(c)});l.promise.cancel=
...
angular.module("ui.bootstrap.collapse",["ui.bootstrap.transition"]).directive("collapse",["$transition",function(a){var b=function(a,b,d){b.removeClass("collapse");b.css({height:d});b.addClass("collapse")};return{link:function(e,c,d){var g,h=!0;e.$watch(function(){return c[0].scrollHeight},function(){0!==c[0].scrollHeight&&(g||(h?b(e,c,c[0].scrollHeight+"px"):b(e,c,"auto")))});e.$watch(d.collapse,function(a){a?(g=!0,h?(h=!1,b(e,c,0)):(b(e,c,c[0].scrollHeight+"px"),k({height:"0"}))):(h?(h=!1,g||b(e,
c,"auto")):k({height:c[0].scrollHeight+"px"}).then(function(){g||b(e,c,"auto")}),g=!1)});var f,k=function(b){f&&f.cancel();f=a(c,b);f.then(function(){f=void 0},function(){f=void 0});return f}}}}]);
...
function(a){this.heading=a}}],link:function(b,e,c,d){var g,h;d.addGroup(b);b.isOpen=!1;c.isOpen&&(g=a(c.isOpen),h=g.assign,b.$watch(function(){return g(b.$parent)},function(a){b.isOpen=a}),b.isOpen=g?g(b.$parent):!1);b.$watch("isOpen",function(a){a&&d.closeOthers(b);h&&h(b.$parent,a)})}}}]).directive("accordionHeading",function(){return{restrict:"E",transclude:!0,template:"",replace:!0,require:"^accordionGroup",compile:function(a,b,e){return function(a,b,g,h){h.setHeading(e(a,function(){}))}}}}).directive("accordionTransclude",
...
angular.module("ui.bootstrap.buttons",[]).constant("buttonConfig",{activeClass:"active",toggleEvent:"click"}).directive("btnRadio",["buttonConfig",function(a){var b=a.activeClass||"active",e=a.toggleEvent||"click";return{require:"ngModel",link:function(a,d,g,h){var f=a.$eval(g.btnRadio);a.$watch(function(){return h.$modelValue},function(a){angular.equals(a,f)?d.addClass(b):d.removeClass(b)});d.bind(e,function(){d.hasClass(b)||a.$apply(function(){h.$setViewValue(f)})})}}}]).directive("btnCheckbox",
["buttonConfig",function(a){var b=a.activeClass||"active",e=a.toggleEvent||"click";return{require:"ngModel",link:function(a,d,g,h){var f=a.$eval(g.btnCheckboxTrue),k=a.$eval(g.btnCheckboxFalse),f=angular.isDefined(f)?f:!0,k=angular.isDefined(k)?k:!1;a.$watch(function(){return h.$modelValue},function(a){angular.equals(a,f)?d.addClass(b):d.removeClass(b)});d.bind(e,function(){a.$apply(function(){h.$setViewValue(d.hasClass(b)?k:f)})})}}}]);
angular.module("ui.bootstrap.carousel",["ui.bootstrap.transition"]).controller("CarouselController",["$scope","$timeout","$transition","$q",function(a,b,e){function c(){function d(){k?(a.next(),c()):a.pause()}f&&b.cancel(f);var e=+a.interval;!isNaN(e)&&0<=e&&(f=b(d,e))}var d=this,g=d.slides=[],h=-1,f,k;d.currentSlide=null;d.select=function(f,j){function k(){if(d.currentSlide&&angular.isString(j)&&!a.noTransition&&f.$element){f.$element.addClass(j);f.$element.attr("offsetWidth",f.$element[0].offsetWidth);
angular.forEach(g,function(a){angular.extend(a,{direction:"",entering:!1,leaving:!1,active:!1})});angular.extend(f,{direction:j,active:!0,entering:!0});angular.extend(d.currentSlide||{},{direction:j,leaving:!0});a.$currentTransition=e(f.$element,{});var b=f,m=d.currentSlide;a.$currentTransition.then(function(){q(b,m)},function(){q(b,m)})}else q(f,d.currentSlide);d.currentSlide=f;h=p;c()}function q(b,d){angular.extend(b,{direction:"",active:!0,leaving:!1,entering:!1});angular.extend(d||{},{direction:"",
active:!1,leaving:!1,entering:!1});a.$currentTransition=null}var p=g.indexOf(f);void 0===j&&(j=p>h?"next":"prev");f&&f!==d.currentSlide&&(a.$currentTransition?(a.$currentTransition.cancel(),b(k)):k())};d.indexOfSlide=function(a){return g.indexOf(a)};a.next=function(){return d.select(g[(h+1)%g.length],"next")};a.prev=function(){return d.select(g[0>h-1?g.length-1:h-1],"prev")};a.select=function(a){d.select(a)};a.isActive=function(a){return d.currentSlide===a};a.slides=function(){return g};a.$watch("interval",
c);a.play=function(){k||(k=!0,c())};a.pause=function(){k=!1;f&&b.cancel(f)};d.addSlide=function(b,c){b.$element=c;g.push(b);1===g.length||b.active?(d.select(g[g.length-1]),1==g.length&&a.play()):b.active=!1};d.removeSlide=function(a){var b=g.indexOf(a);g.splice(b,1);0<g.length&&a.active&&(b>=g.length?d.select(g[b-1]):d.select(g[b]))}}]).directive("carousel",[function(){return{restrict:"EA",transclude:!0,replace:!0,controller:"CarouselController",require:"carousel",templateUrl:"template/carousel/carousel.html",
...
angular.module("ui.bootstrap.modal",["ui.bootstrap.dialog"]).directive("modal",["$parse","$dialog",function(a,b){return{restrict:"EA",terminal:!0,link:function(e,c,d){var g=angular.extend({},e.$eval(d.uiOptions||d.bsOptions||d.options)),h=d.modal||d.show,f,g=angular.extend(g,{template:c.html(),resolve:{$scope:function(){return e}}}),k=b.dialog(g);c.remove();f=d.close?function(){a(d.close)(e)}:function(){angular.isFunction(a(h).assign)&&a(h).assign(e,!1)};e.$watch(h,function(a){a?k.open().then(function(){f()}):
k.isOpen()&&k.close()})}}}]);
...
function(a,b,e,c,d){var g=[9,13,27,38,40];return{require:"ngModel",link:function(h,f,k,l){var j,m=h.$eval(k.typeaheadMinLength)||1,q=d.parse(k.typeahead),p=!1!==h.$eval(k.typeaheadEditable),r=b(k.typeaheadLoading).assign||angular.noop,n=h.$new();h.$on("$destroy",function(){n.$destroy()});var t=function(){n.matches=[];n.activeIdx=-1};t();n.query=void 0;l.$parsers.push(function(a){t();if(j)return a;if(a&&a.length>=m){var b={$viewValue:a};r(h,!0);e.when(q.source(n,b)).then(function(c){if(a===l.$viewValue){if(0<
...
(a.preventDefault(),40===a.which?(n.activeIdx=(n.activeIdx+1)%n.matches.length,n.$digest()):38===a.which?(n.activeIdx=(n.activeIdx?n.activeIdx:n.matches.length)-1,n.$digest()):13===a.which||9===a.which?n.$apply(function(){n.select(n.activeIdx)}):27===a.which&&(a.stopPropagation(),t(),n.$digest()))});c.find("body").bind("click",function(){t();n.$digest()});k=a("<typeahead-popup matches='matches' active='activeIdx' select='select(activeIdx)' query='query'></typeahead-popup>")(n);f.after(k)}}}]).directive("typeaheadPopup",
...
b}});(function(){angular.module("hutmap",["hutmapServices","hutmapFilters","AngularGM","ngResource","ui.bootstrap"]).config(["$routeProvider","$locationProvider","PlacesProvider",function(a,b,e){a.when("/",{templateUrl:"/partials/home.html",activetab:"home"}).when("/map/",{templateUrl:"/partials/map.html",activetab:"map",reloadOnSearch:!1}).when("/about/",{templateUrl:"/partials/about.html",activetab:"about"});b.html5Mode(!0);e.bounds(new google.maps.LatLngBounds(new google.maps.LatLng(30,-130),new google.maps.LatLng(65,
-80)))}]).constant("hutmapMapId","map_canvas").value("mapOptions",{zoom:8,center:new google.maps.LatLng(46.87916,-120),mapTypeId:google.maps.MapTypeId.TERRAIN,streetViewControl:!1}).value("markerOptions",{huts:{icon:"/static/img/marker_gray_small.png",shape:{coord:[6,0,2,2,0,6,6,13,12,6,10,2,6,0],type:"poly"},zIndex:0},filteredHuts:{icon:"/static/img/marker_red_small.png",shape:{coord:[6,0,2,2,0,6,6,13,12,6,10,2,6,0],type:"poly"},zIndex:1},selected:{icon:"/static/img/marker_yellow_small.png",zIndex:2}})})();(function(){angular.module("hutmapServices",[]).factory("Huts",["$http","$q","utils",function(a,b,e){function c(a){if(null==a)throw"id should not be null";a.constructor===String&&-1<a.indexOf("/")&&(a=a.slice(0,-1),a=a.slice(a.lastIndexOf("/")+1));return Number(a)}var d={},g,h=b.defer();a.get("/static/data/huts.json").success(function(a){null!=a?(g=a,h.resolve()):h.reject("/static/data/huts.json response was null")}).error(function(a){h.reject(a)});d.query=function(a){return h.promise.then(function(){var b=
a||{},c=b.bounds,d=b.limit||0,h=[];angular.forEach(g.huts.object_index,function(a){var b;if(b=0===d||h.length<d)c?(b=e.latLngFromHut(a),b=c.contains(b)):b=!0;b&&h.push(a)});return h})};d.totalHutCount=function(){return h.promise.then(function(){return g.huts.meta.total_count})};d.hut=function(a){return h.promise.then(function(){var b=c(a);return g.huts.object_index[b]})};d.agency=function(a){return h.promise.then(function(){var b=c(a);return g.agencies.object_index[b]})};d.region=function(a){return h.promise.then(function(){var b=
c(a);return g.regions.object_index[b]})};return d}]).provider("Places",[function(){var a={},b=new google.maps.LatLngBounds(new google.maps.LatLng(-90,180),new google.maps.LatLng(90,-180));a.bounds=function(a){b=a};a.$get=function(){function a(b,c,d,e){e==google.maps.places.PlacesServiceStatus.OK?b(d):c(d)}var c={},d=angular.element('<div id="google-attributions"></div>'),g=new google.maps.places.PlacesService(d[0]),h=new google.maps.places.AutocompleteService;c.getPlacePredictions=function(c,d,g){h.getPlacePredictions({input:c,
bounds:b},angular.bind(this,a,d,g))};c.getDetails=function(b,c,d){g.getDetails({reference:b},angular.bind(this,a,c,d))};c.textSearch=function(b,c,d){g.textSearch(b,angular.bind(this,a,c,d))};return c};return a}]).factory("utils",[function(){return{latLngFromUrlValue:function(a){a=a.split(",");return new google.maps.LatLng(a[0],a[1])},latLngFromHut:function(a){return new google.maps.LatLng(a.location.coordinates[1],a.location.coordinates[0])},boundsFromUrlValue:function(a){a=a.split(",");return new google.maps.LatLngBounds(new google.maps.LatLng(a[0],
a[1]),new google.maps.LatLng(a[2],a[3]))}}}])})();(function(){angular.module("hutmapFilters",[]).filter("truncate",function(){return function(a,b,e){isNaN(b)&&(b=10);void 0===e&&(e="...");return null==a||0==a.length?null:a.length<=b||a.length-e.length<=b?a:String(a).substring(0,b-e.length)+e}})})();(function(){angular.module("hutmap.directives",[])})();(function(){angular.module("hutmap").controller("HutCtrl",["$scope","$location","$timeout","Huts",function(a,b,e,c){var d=0;a.loading=0;a.huts;a.filteredHuts;a.totalHutCount;a.query;a.selectedHut;a.selectedHutRegion;a.selectedHutAgency;a.resetLoading=function(){a.loading=0};a.incLoading=function(){a.loading++};a.decLoading=function(){0<a.loading&&a.loading--};a.setQuery=function(b){a.query=b};a.setFilteredHuts=function(b){a.filteredHuts=b};a.setSelectedHut=function(b){if(a.selectedHut=b)c.agency(b.agency).then(function(b){a.selectedHutAgency=
b}),c.region(b.region).then(function(b){a.selectedHutRegion=b})};a.$watch("query",function(b){if(null!=b){var h=++d;e(function(){h===d&&b&&(a.incLoading(),c.query(b).then(function(b){a.decLoading();h===d&&(a.resetLoading(),a.huts=b)},function(){a.decLoading()}))},1E3)}});c.totalHutCount().then(function(b){a.totalHutCount=b})}])})();(function(){angular.module("hutmap").controller("HutmapCtrl",["$scope","$route",function(a,b){a.$route=b}]).controller("CarouselCtrl",["$scope","$route","$http","$q",function(a,b,e,c){a.slides=[{title:"Plummer Hut",location:"Waddington Range, British Columbia, Canada",hutLink:"/map/?m_selected=51.37361,-125.16458&m_center=51.388403,-125.062053&m_zoom=9",agency:{name:"BC Mountaineering Club",url:""},thumbnail:"/static/img/no-image-available.gif",image:"/static/img/carousel/Plummer Hut.JPG"},{title:"Joe River Chickee",
...
function(a){d.push(e.get(a.image))});c.all(d).then(function(){a.carouselInterval=8E3})}]).controller("AlertCtrl",["$scope",function(a){a.alerts=[];a.addAlert=function(b,e){a.alerts.push({type:b,msg:e})};a.closeAlert=function(b){a.alerts.splice(b,1)}}]).controller("HutInfoCtrl",["$scope",function(a){a.accuracy_tooltip="Coordinates provided, but unverifiable.;Wild ass guess.;Slightly better than a wild ass guess.;Found structure on satellite or topo map.;Surveyed with GPS by the Hutmap team.;Found on a map and surveyed by the Hutmap team.".split(";")}])})();(function(){angular.module("hutmap").controller("SearchCtrl",["$scope","$location","$route","$log","Places",function(a,b,e,c,d){a.submitting=!1;a.autocompleting=0;a.lastQuery;a.selected;a.getPlaces=function(b){return(a.lastQuery=b)&&!a.submitting?(a.autocompleting++,d.getPlacePredictions(b).then(function(b){0<a.autocompleting&&a.autocompleting--;return a.submitting?[]:b},function(){0<a.autocompleting&&a.autocompleting--;return[]})):[]};var g=function(b){a.submitting=!1;c.error(b);a.addAlert("error",
"There was an error retrieving search results. TODO: better messages")},h=function(c){a.submitting=!1;e.reload();b.path("/map/").search({}).search("m_zoom",8);c.geometry.location&&(b.search("m_center",c.geometry.location.toUrlValue()),b.search("m_selected",c.geometry.location.toUrlValue()));c.geometry.viewport&&b.search("m_bounds",c.geometry.viewport.toUrlValue())};a.$watch("selected",function(b){b&&a.submit()});a.submit=function(){if(a.selected){a.submitting=!0;a.autocompleting=0;var b=a.selected;
b.reference&&d.getDetails(b.reference).then(function(a){h(a)},g)}else if(b=a.lastQuery)a.submitting=!0,a.autocompleting=0,d.getPlacePredictions(b).then(function(a){d.getDetails(a[0].reference).then(function(a){h(a)},g)},g)}}])})();(function(){angular.module("hutmap").controller("FilterCtrl",["$scope","$timeout",function(a,b){function e(){var b={},d,e=[];angular.forEach(a.shelterType,function(a){a.include&&(e=e.concat(a.keywords))});d=e;angular.forEach(a.huts,function(e){var f;f=a.season;f=!f.winter&&!f.summer?!0:f.winter&&e.open_winter||f.summer&&e.open_summer;if(f){var g=!1;a.anyShelterType?g=!0:angular.forEach(d,function(a){~e.types.indexOf(a)&&(g=!0)});f=g}f&&(b[e.id]=e)});a.setFilteredHuts(b);a.$broadcast("gmMarkersRedraw",
"huts")}a.season={winter:!1,summer:!1};a.seasonTooltip=function(){var b=a.season.winter,d=a.season.summer,e="Showing huts that are open in ";return b&&d?e+"both winter and summer":b&&!d?e+"winter":!b&&d?e+"summer":"Not filtering by season"};a.anyShelterType=!0;a.shelterType={"emergency shelters":{include:!1,keywords:["Emergency Shelter","Refuge"]},"fire lookouts":{include:!1,keywords:["Fire Lookout"]},"huts & yurts":{include:!1,keywords:"Hut;Yurt;Chickee;Lean-to;Wall Tent;Shelter".split(";")},compounds:{include:!1,
keywords:"Compound;Hostel;Tea House;Lodge;Chalet;Ranch;Farm".split(";")}};a.setAnyShelterType=function(b){a.anyShelterType=b};a.$watch("anyShelterType",function(b){b&&angular.forEach(a.shelterType,function(a){a.include=!1})});a.filter=function(){a.incLoading();b(e).then(function(){a.decLoading()})};a.$watch("huts",function(){a.filter()})}])})();(function(){angular.module("hutmap").controller("MapConfigCtrl",["$scope","$http","hutmapMapId","angulargmContainer","mapOptions","markerOptions",function(a,b,e,c,d,g){b=c.getMapPromise(e);var h,f;a.hutmapMapId=e;a.mapOptions=d;a.markerOptions=g;a.getMarkerOptions=function(b){var d={title:b.name};return a.filteredHuts&&b.id in a.filteredHuts?angular.extend(d,a.markerOptions.filteredHuts):angular.extend(d,a.markerOptions.huts)};a.selectHut=function(b,d){if(h){var c=angular.extend({},g.huts,{icon:f});
h.setOptions(c)}h=b;f=b.getIcon();b.setOptions(g.selected);a.setSelectedHut(d)};b.then(function(a){var b={MSR_TOPO:new google.maps.ImageMapType({name:"MSR USGS",alt:"USGS topos from Microsoft Research",minZoom:1,maxZoom:15,tileSize:new google.maps.Size(256,256),isPng:!1,getTileUrl:function(b,d){var c=a.getProjection(),e=Math.pow(2,d),f=new google.maps.Point(256*b.x/e,256*(b.y+1)/e),e=new google.maps.Point(256*(b.x+1)/e,256*b.y/e),f=c.fromPointToLatLng(f),c=c.fromPointToLatLng(e);return"http://msrmaps.com/ogcmap.ashx?version=1.1.1&request=GetMap&Layers=drg&Styles=default&SRS=EPSG:4326&BBOX="+
[f.lng(),f.lat(),c.lng(),c.lat()].join()+"&width=256&height=256&format=image/jpeg"}}),ARC_GIS_USA:new google.maps.ImageMapType({name:"ArcGIS USA",alt:"ArcGIS USA Topos",minZoom:1,maxZoom:15,tileSize:new google.maps.Size(256,256),isPng:!0,getTileUrl:function(a,b){var d=1<<b,c=a.x%d;0>c&&(c+=d);return"http://services.arcgisonline.com/ArcGIS/rest/services/USA_Topo_Maps/MapServer/tile/"+parseInt(b)+"/"+a.y+"/"+c}}),ARC_GIS_WORLD:new google.maps.ImageMapType({name:"ArcGIS World",alt:"ArcGIS World Topos",
...
b.ARC_GIS_WORLD.name]}});a.enableKeyDragZoom({key:"alt",visualEnabled:!0})})}])})();(function(){angular.module("hutmap").controller("MapCtrl",["$scope","$location","$timeout","$q","utils",function(a,b,e,c,d){var g=c.defer(),h=c.defer();a.center;a.zoom;a.bounds;a.hutMarkerEvents;var f=function(){h.promise.then(function(){a.setSelectedHut(null);var c=b.search().m_selected;null!=c&&(a.hutMarkerEvents=[{event:"click",locations:[d.latLngFromUrlValue(c)]}])})};e=function(c,d){if(c!==d&&(a.center&&b.search("m_center",a.center.toUrlValue()),a.zoom&&b.search("m_zoom",a.zoom),a.selectedHut)){var e=
a.selectedHut.location;b.search("m_selected",e.coordinates[1]+","+e.coordinates[0])}};a.$watch("center != null && zoom != null",function(a){a&&g.resolve()});a.$watch("huts != null",function(a){a&&h.resolve()});a.$watch("center",e);a.$watch("zoom",e);a.$watch("selectedHut",e);a.$watch("bounds",function(b){b&&a.setQuery({bounds:b})});a.$on("gmMarkersUpdated",function(a,b){"huts"===b&&f()});var k=b.search().m_center,l=b.search().m_zoom,j=b.search().m_bounds;b.search("m_center",null);b.search("m_zoom",
null);b.search("m_bounds",null);g.promise.then(function(){var b=null!=j;!b&&null!=k&&(a.center=d.latLngFromUrlValue(k));!b&&null!=l&&(a.zoom=Number(l));b&&(a.bounds=d.boundsFromUrlValue(j))});f()}])})();

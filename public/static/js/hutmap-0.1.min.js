...
var f=!1,g=!1,h=!1;c.hasOwnProperty("gmCenter")&&(f=!0);c.hasOwnProperty("gmZoom")&&(g=!0);c.hasOwnProperty("gmBounds")&&(h=!0);d=function(){a(function(){(f||g||h)&&b.$apply(function(){if(f&&(b.gmCenter=e.center),g&&(b.gmZoom=e.zoom),h){var a=e.bounds;a&&(b.gmBounds=a)}})})};e.addMapListener("drag",d);e.addMapListener("zoom_changed",d);e.addMapListener("center_changed",d);e.addMapListener("bounds_changed",d);f&&b.$watch("gmCenter",function(a,c){a!==c&&!e.dragging&&a&&(e.center=a)},!0);g&&b.$watch("gmZoom",
...
angular.lowercase(c.substring(4)),e=b(a);n[j]=e}});var j=function(c){var b=a.gmMarkerOptions(),j={};angular.forEach(c,function(c){var l=a.gmGetLatLng({object:c}),g=e(l);if(null!=g){var h=g.toUrlValue(k.precision);if(j[h]=c,!k.hasMarker(l.lat,l.lng)){h={};angular.extend(h,b,{position:g});k.addMarker(h);var q=k.getMarker(l.lat,l.lng);angular.forEach(n,function(b,l){k.addListener(q,l,function(){d(function(){b(a.$parent.$parent,{object:c,marker:q})})})})}}});var g=[];k.forEachMarker(function(a){a.getPosition().toUrlValue(k.precision)in
j||g.push(a)});angular.forEach(g,function(a){a=a.getPosition();k.removeMarker(a.lat(),a.lng())})};a.$watch("gmObjects().length",function(c,b){null!=c&&c!==b&&j(a.gmObjects())});a.$watch("gmObjects()",function(c,b){null!=c&&c!==b&&j(a.gmObjects())});a.$watch("gmEvent()",function(a,c){if(null!=a&&a!==c){var b=a.event,j=a.location,j=k.getMarker(j.lat(),j.lng());null!=j&&d(angular.bind(this,k.trigger,j,b))}});d(angular.bind(null,j,a.gmObjects()))}}}])})();
...
function(a){this.heading=a}}],link:function(b,d,c,e){var f,g;e.addGroup(b);b.isOpen=!1;c.isOpen&&(f=a(c.isOpen),g=f.assign,b.$watch(function(){return f(b.$parent)},function(a){b.isOpen=a}),b.isOpen=f?f(b.$parent):!1);b.$watch("isOpen",function(a){a&&e.closeOthers(b);g&&g(b.$parent,a)})}}}]).directive("accordionHeading",function(){return{restrict:"E",transclude:!0,template:"",replace:!0,require:"^accordionGroup",compile:function(a,b,d){return function(a,b,f,g){g.setHeading(d(a,function(){}))}}}}).directive("accordionTransclude",
...
angular.module("ui.bootstrap.buttons",[]).constant("buttonConfig",{activeClass:"active",toggleEvent:"click"}).directive("btnRadio",["buttonConfig",function(a){var b=a.activeClass||"active",d=a.toggleEvent||"click";return{require:"ngModel",link:function(a,e,f,g){var h=a.$eval(f.btnRadio);a.$watch(function(){return g.$modelValue},function(a){angular.equals(a,h)?e.addClass(b):e.removeClass(b)});e.bind(d,function(){e.hasClass(b)||a.$apply(function(){g.$setViewValue(h)})})}}}]).directive("btnCheckbox",
["buttonConfig",function(a){var b=a.activeClass||"active",d=a.toggleEvent||"click";return{require:"ngModel",link:function(a,e,f,g){var h=a.$eval(f.btnCheckboxTrue),k=a.$eval(f.btnCheckboxFalse),h=angular.isDefined(h)?h:!0,k=angular.isDefined(k)?k:!1;a.$watch(function(){return g.$modelValue},function(a){angular.equals(a,h)?e.addClass(b):e.removeClass(b)});e.bind(d,function(){a.$apply(function(){g.$setViewValue(e.hasClass(b)?k:h)})})}}}]);
angular.module("ui.bootstrap.carousel",["ui.bootstrap.transition"]).controller("CarouselController",["$scope","$timeout","$transition","$q",function(a,b,d){function c(){function e(){k?(a.next(),c()):a.pause()}h&&b.cancel(h);var j=+a.interval;!isNaN(j)&&0<=j&&(h=b(e,j))}var e=this,f=e.slides=[],g=-1,h,k;e.currentSlide=null;e.select=function(h,j){function l(){if(e.currentSlide&&angular.isString(j)&&!a.noTransition&&h.$element){h.$element.addClass(j);h.$element.attr("offsetWidth",h.$element[0].offsetWidth);
angular.forEach(f,function(a){angular.extend(a,{direction:"",entering:!1,leaving:!1,active:!1})});angular.extend(h,{direction:j,active:!0,entering:!0});angular.extend(e.currentSlide||{},{direction:j,leaving:!0});a.$currentTransition=d(h.$element,{});var b=h,l=e.currentSlide;a.$currentTransition.then(function(){m(b,l)},function(){m(b,l)})}else m(h,e.currentSlide);e.currentSlide=h;g=p;c()}function m(c,b){angular.extend(c,{direction:"",active:!0,leaving:!1,entering:!1});angular.extend(b||{},{direction:"",
active:!1,leaving:!1,entering:!1});a.$currentTransition=null}var p=f.indexOf(h);void 0===j&&(j=p>g?"next":"prev");h&&h!==e.currentSlide&&(a.$currentTransition?(a.$currentTransition.cancel(),b(l)):l())};e.indexOfSlide=function(a){return f.indexOf(a)};a.next=function(){return e.select(f[(g+1)%f.length],"next")};a.prev=function(){return e.select(f[0>g-1?f.length-1:g-1],"prev")};a.select=function(a){e.select(a)};a.isActive=function(a){return e.currentSlide===a};a.slides=function(){return f};a.$watch("interval",
c);a.play=function(){k||(k=!0,c())};a.pause=function(){k=!1;h&&b.cancel(h)};e.addSlide=function(c,b){c.$element=b;f.push(c);1===f.length||c.active?(e.select(f[f.length-1]),1==f.length&&a.play()):c.active=!1};e.removeSlide=function(a){var c=f.indexOf(a);f.splice(c,1);0<f.length&&a.active&&(c>=f.length?e.select(f[c-1]):e.select(f[c]))}}]).directive("carousel",[function(){return{restrict:"EA",transclude:!0,replace:!0,controller:"CarouselController",require:"carousel",templateUrl:"template/carousel/carousel.html",
...
var q=e.find("body");p.prototype.isOpen=function(){return this._open};p.prototype.open=function(a,c){var b=this,l=this.options;a&&(l.templateUrl=a);c&&(l.controller=c);if(!l.template&&!l.templateUrl)throw Error("Dialog.open expected template or templateUrl, neither found. Use options or open method to specify them.");this._loadResolves().then(function(a){var c=a.$scope=b.$scope=a.$scope?a.$scope:g.$new();b.modalEl.html(a.$template);b.options.controller&&(a=h(b.options.controller,a),b.modalEl.contents().data("ngControllerController",
...
if(0<e.length)for(var g=e.length-1;0<=g;g--)j(e[g],c).then(b);else this._onCloseComplete(a)};p.prototype._getFadingElements=function(){var a=[];this.options.dialogFade&&a.push(this.modalEl);this.options.backdropFade&&a.push(this.backdropEl);return a};p.prototype._bindEvents=function(){this.options.keyboard&&q.bind("keydown",this.handledEscapeKey);this.options.backdrop&&this.options.backdropClick&&this.backdropEl.bind("click",this.handleBackDropClick)};p.prototype._unbindEvents=function(){this.options.keyboard&&
...
c.dialog=j;return c})};return{dialog:function(a){return new p(a)},messageBox:function(a,c,b){return new p({templateUrl:"template/dialog/message.html",controller:"MessageBoxController",resolve:{model:function(){return{title:a,message:c,buttons:b}}}})}}}]});
...
angular.module("ui.bootstrap.modal",["ui.bootstrap.dialog"]).directive("modal",["$parse","$dialog",function(a,b){return{restrict:"EA",terminal:!0,link:function(d,c,e){var f=angular.extend({},d.$eval(e.uiOptions||e.bsOptions||e.options)),g=e.modal||e.show,h,f=angular.extend(f,{template:c.html(),resolve:{$scope:function(){return d}}}),k=b.dialog(f);c.remove();h=e.close?function(){a(e.close)(d)}:function(){angular.isFunction(a(g).assign)&&a(g).assign(d,!1)};d.$watch(g,function(a){a?k.open().then(function(){h()}):
k.isOpen()&&k.close()})}}}]);
angular.module("ui.bootstrap.pagination",[]).constant("paginationConfig",{boundaryLinks:!1,directionLinks:!0,firstText:"First",previousText:"Previous",nextText:"Next",lastText:"Last"}).directive("pagination",["paginationConfig",function(a){return{restrict:"EA",scope:{numPages:"=",currentPage:"=",maxSize:"=",onSelectPage:"&"},templateUrl:"template/pagination/pagination.html",replace:!0,link:function(b,d,c){function e(a,c,b,e){return{number:a,text:c,active:b,disabled:e}}var f=angular.isDefined(c.boundaryLinks)?
b.$eval(c.boundaryLinks):a.boundaryLinks,g=angular.isDefined(c.directionLinks)?b.$eval(c.directionLinks):a.directionLinks,h=angular.isDefined(c.firstText)?c.firstText:a.firstText,k=angular.isDefined(c.previousText)?c.previousText:a.previousText,n=angular.isDefined(c.nextText)?c.nextText:a.nextText,j=angular.isDefined(c.lastText)?c.lastText:a.lastText;b.$watch("numPages + currentPage + maxSize",function(){b.pages=[];var a=b.maxSize&&b.maxSize<b.numPages?b.maxSize:b.numPages,c=b.currentPage-Math.floor(a/
2);1>c&&(c=1);c+a-1>b.numPages&&(c-=c+a-1-b.numPages);for(var d=c,a=c+a;d<a;d++)c=e(d,d,b.isActive(d),!1),b.pages.push(c);g&&(d=e(b.currentPage-1,k,!1,b.noPrevious()),b.pages.unshift(d),d=e(b.currentPage+1,n,!1,b.noNext()),b.pages.push(d));f&&(d=e(1,h,!1,b.noPrevious()),b.pages.unshift(d),d=e(b.numPages,j,!1,b.noNext()),b.pages.push(d));b.currentPage>b.numPages&&b.selectPage(b.numPages)});b.noPrevious=function(){return 1===b.currentPage};b.noNext=function(){return b.currentPage===b.numPages};b.isActive=
...
replace:!0}}).directive("pane",["$parse",function(a){return{require:"^tabs",restrict:"EA",transclude:!0,scope:{heading:"@"},link:function(b,d,c,e){var f,g;b.selected=!1;c.active&&(f=a(c.active),g=f.assign,b.$watch(function(){return f(b.$parent)},function(a){b.selected=a}),b.selected=f?f(b.$parent):!1);b.$watch("selected",function(a){a&&e.select(b);g&&g(b.$parent,a)});e.addPane(b);b.$on("$destroy",function(){e.removePane(b)})},templateUrl:"template/tabs/pane.html",replace:!0}}]);
angular.module("ui.bootstrap.tooltip",[]).provider("$tooltip",function(){var a={placement:"top",animation:!0},b={};this.options=function(a){angular.extend(b,a)};this.$get=["$window","$compile","$timeout","$parse",function(d,c,e,f){return function(g,h,k){var n=angular.extend({},a,b),j="<"+g+'-popup title="{{tt_title}}" content="{{tt_content}}" placement="{{tt_placement}}" animation="tt_animation()" is-open="tt_isOpen"></'+g+"-popup>";return{restrict:"EA",scope:!0,link:function(a,b,p){function q(){var c,
...
a.tt_isOpen=!0}}function t(){a.tt_isOpen=!1;angular.isDefined(a.tt_animation)&&a.tt_animation()?s=e(function(){r.remove()},500):r.remove()}var r=c(j)(a),s;p.$observe(g,function(c){a.tt_content=c});p.$observe(g+"Title",function(c){a.tt_title=c});p.$observe(g+"Placement",function(c){a.tt_placement=angular.isDefined(c)?c:n.placement});p.$observe(g+"Animation",function(c){a.tt_animation=angular.isDefined(c)?f(c):function(){return n.animation}});a.tt_isOpen=!1;angular.isDefined(k)?(b.bind(h,function(){a.$apply(q)}),
...
function(a,b,d,c){var e=[9,13,27,38,40];return{require:"ngModel",link:function(f,g,h,k){var n=k.$modelValue,j=f.$eval(h.typeaheadMinLength)||1,l=c.parse(h.typeahead),m=f.$new();f.$on("$destroy",function(){m.$destroy()});var p=function(){m.matches=[];m.activeIdx=-1};p();m.query=void 0;k.$parsers.push(function(a){p();if(n)return a;if(a&&a.length>=j){var c={$viewValue:a};b.when(l.source(m,c)).then(function(b){if(a===k.$viewValue)if(0<b.length){m.activeIdx=0;for(var j=m.matches.length=0;j<b.length;j++)c[l.itemName]=
b[j],m.matches.push({label:l.viewMapper(m,c),model:b[j]});m.query=a}else p()},p)}});k.$render=function(){var a={};a[l.itemName]=n;g.val(l.viewMapper(m,a)||k.$viewValue);n=void 0};m.select=function(a){var c={};c[l.itemName]=n=m.matches[a].model;k.$setViewValue(l.modelMapper(m,c));k.$render()};g.bind("keydown",function(a){0===m.matches.length||-1===e.indexOf(a.which)||(a.preventDefault(),40===a.which?(m.activeIdx=(m.activeIdx+1)%m.matches.length,m.$digest()):38===a.which?(m.activeIdx=(m.activeIdx?m.activeIdx:
m.matches.length)-1,m.$digest()):13===a.which||9===a.which?m.$apply(function(){m.select(m.activeIdx)}):27===a.which&&(a.stopPropagation(),m.matches=[],m.$digest()))});d.find("body").bind("click",function(){m.matches=[];m.$digest()});f=a("<typeahead-popup matches='matches' active='activeIdx' select='select(activeIdx)' query='query'></typeahead-popup>")(m);g.after(f)}}}]).directive("typeaheadPopup",function(){return{restrict:"E",scope:{matches:"=",query:"=",active:"=",select:"&"},replace:!0,templateUrl:"template/typeahead/typeahead.html",
...
angular.module("template/tooltip/tooltip-popup.html",[]).run(["$templateCache",function(a){a.put("template/tooltip/tooltip-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">  <div class="tooltip-arrow"></div>  <div class="tooltip-inner" ng-bind="content"></div></div>')}]);angular.module("template/typeahead/typeahead.html",[]).run(["$templateCache",function(a){a.put("template/typeahead/typeahead.html",'<div class="dropdown clearfix" ng-class="{open: isOpen()}">    <ul class="typeahead dropdown-menu">        <li ng-repeat="match in matches" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)">            <a tabindex="-1" ng-click="selectMatch($index)" ng-bind-html-unsafe="match.label | typeaheadHighlight:query"></a>        </li>    </ul></div>')}]);!function(a){var b=function(a,b){this.init("tooltip",a,b)};b.prototype={constructor:b,init:function(c,b,d){var g;this.type=c;this.$element=a(b);this.options=this.getOptions(d);this.enabled=!0;b=this.options.trigger.split(" ");for(d=b.length;d--;)if(g=b[d],"click"==g)this.$element.on("click."+this.type,this.options.selector,a.proxy(this.toggle,this));else"manual"!=g&&(c="hover"==g?"mouseenter":"focus",g="hover"==g?"mouseleave":"blur",this.$element.on(c+"."+this.type,this.options.selector,a.proxy(this.enter,
this)),this.$element.on(g+"."+this.type,this.options.selector,a.proxy(this.leave,this)));this.options.selector?this._options=a.extend({},this.options,{trigger:"manual",selector:""}):this.fixTitle()},getOptions:function(c){c=a.extend({},a.fn[this.type].defaults,this.$element.data(),c);c.delay&&"number"==typeof c.delay&&(c.delay={show:c.delay,hide:c.delay});return c},enter:function(c){var b=a.fn[this.type].defaults,d={},g;this._options&&a.each(this._options,function(a,c){b[a]!=c&&(d[a]=c)},this);g=
a(c.currentTarget)[this.type](d).data(this.type);if(!g.options.delay||!g.options.delay.show)return g.show();clearTimeout(this.timeout);g.hoverState="in";this.timeout=setTimeout(function(){"in"==g.hoverState&&g.show()},g.options.delay.show)},leave:function(c){var b=a(c.currentTarget)[this.type](this._options).data(this.type);this.timeout&&clearTimeout(this.timeout);if(!b.options.delay||!b.options.delay.hide)return b.hide();b.hoverState="out";this.timeout=setTimeout(function(){"out"==b.hoverState&&
b.hide()},b.options.delay.hide)},show:function(){var c,b,d,g,h;b=a.Event("show");if(this.hasContent()&&this.enabled&&(this.$element.trigger(b),!b.isDefaultPrevented())){c=this.tip();this.setContent();this.options.animation&&c.addClass("fade");g="function"==typeof this.options.placement?this.options.placement.call(this,c[0],this.$element[0]):this.options.placement;c.detach().css({top:0,left:0,display:"block"});this.options.container?c.appendTo(this.options.container):c.insertAfter(this.$element);b=
this.getPosition();d=c[0].offsetWidth;c=c[0].offsetHeight;switch(g){case "bottom":h={top:b.top+b.height,left:b.left+b.width/2-d/2};break;case "top":h={top:b.top-c,left:b.left+b.width/2-d/2};break;case "left":h={top:b.top+b.height/2-c/2,left:b.left-d};break;case "right":h={top:b.top+b.height/2-c/2,left:b.left+b.width}}this.applyPlacement(h,g);this.$element.trigger("shown")}},applyPlacement:function(a,b){var d=this.tip(),g=d[0].offsetWidth,h=d[0].offsetHeight,k,n,j;d.offset(a).addClass(b).addClass("in");
k=d[0].offsetWidth;n=d[0].offsetHeight;"top"==b&&n!=h&&(a.top=a.top+h-n,j=!0);"bottom"==b||"top"==b?(h=0,0>a.left&&(h=-2*a.left,a.left=0,d.offset(a),k=d[0].offsetWidth),this.replaceArrow(h-g+k,k,"left")):this.replaceArrow(n-h,n,"top");j&&d.offset(a)},replaceArrow:function(a,b,d){this.arrow().css(d,a?50*(1-a/b)+"%":"")},setContent:function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")},hide:function(){var c=
...
!0};a.prototype.onMouseMove_=function(a){this.mousePosn_=g(a);if(this.dragging_){this.endPt_=this.getMousePoint_(a);a=Math.min(this.startPt_.x,this.endPt_.x);var b=Math.min(this.startPt_.y,this.endPt_.y),c=Math.abs(this.startPt_.x-this.endPt_.x),d=Math.abs(this.startPt_.y-this.endPt_.y),e=Math.max(0,c-(this.boxBorderWidths_.left+this.boxBorderWidths_.right)),f=Math.max(0,d-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom));this.veilDiv_[0].style.top="0px";this.veilDiv_[0].style.left="0px";
...
"px",this.boxDiv_.style.height=Math.abs(f.y-g.y)-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom)+"px",setTimeout(function(){c.boxDiv_.style.display="none"},1E3));this.dragging_=!1;this.onMouseMove_(a);google.maps.event.trigger(this,"dragend",d);if(!this.isHotKeyDown_(a))this.onKeyUp_(a)}};a.prototype.onKeyUp_=function(){var a,b,c,d,e;b=null;if(this.map_&&this.hotKeyDown_){this.hotKeyDown_=!1;this.dragging_&&(this.boxDiv_.style.display="none",this.dragging_=!1,a=Math.min(this.startPt_.x,this.endPt_.x),
...
{huts:{icon:"/static/img/marker_gray_small.png",shape:{coord:[6,0,2,2,0,6,6,13,12,6,10,2,6,0],type:"poly"},zIndex:0},selected:{icon:"/static/img/marker_yellow_small.png",zIndex:1}})})();(function(){angular.module("hutmapFilters",[]).filter("truncate",function(){return function(a,b,d){isNaN(b)&&(b=10);void 0===d&&(d="...");return null==a||0==a.length?null:a.length<=b||a.length-d.length<=b?a:String(a).substring(0,b-d.length)+d}})})();(function(){angular.module("hutmap.directives",[])})();(function(){angular.module("hutmap").controller("HutCtrl",["$scope","$location","Huts",function(a,b,d){var c=0;a.huts;a.hutsMeta;a.query;a.selectedHut;a.setQuery=function(b){a.query=b};a.setSelectedHut=function(b){a.selectedHut=b};a.$watch("query",function(b){if(null!=b&&b){var f=++c;a.incLoading();var g=d.query(b,function(){a.decLoading();f===c&&(a.huts=g.objects,a.hutsMeta=g.meta)},function(){a.decLoading()})}});a.$watch("hutsMeta.total_count",function(a){a&&console.log(a)})}])})();(function(){angular.module("hutmap").controller("HutmapCtrl",["$scope","$route","$location","$timeout","$log","angulargmContainer",function(a,b){a.$route=b;a.loading=0;a.incLoading=function(){a.loading++};a.decLoading=function(){a.loading--};a.alerts=[];a.addAlert=function(b,c){a.alerts.push({type:b,msg:c})};a.closeAlert=function(b){a.alerts.splice(b,1)}}]).controller("CarouselCtrl",["$scope","$route",function(a){a.carouselInterval=6E3;a.slides=[{title:"Big Hut",text:"lorem ipsum dolor",image:"https://mail-attachment.googleusercontent.com/attachment/u/0/?ui=2&ik=8768b5ed5b&view=att&th=13ba670d57d0c5f1&attid=0.3&disp=inline&realattid=f_haswzj3n2&safe=1&zw&saduie=AG9B_P9lJiRTwBR09D1jE4IKml8C&sadet=1363715869360&sads=7jqjo-uAUQ2mWgLwJ-5zPIGflA0"},
...
["$scope",function(a){a.accuracy_tooltip="Coordinates provided, but unverifiable.;Wild ass guess.;Slightly better than a wild ass guess.;Found structure on satellite or topo map.;Surveyed with GPS by the Hutmap team.;Found on a map and surveyed by the Hutmap team.".split(";")}])})();(function(){angular.module("hutmap").controller("SearchCtrl",["$scope","$location","$route","$log","Places",function(a,b,d,c,e){a.submitting=!1;a.autocompleting=0;a.lastQuery;a.selected;a.getPlaces=function(b){return(a.lastQuery=b)&&!a.submitting?(a.autocompleting++,e.getPlacePredictions(b).then(function(b){a.autocompleting--;return a.submitting?[]:b},function(){a.autocompleting--;return[]})):[]};var f=function(b){a.submitting=!1;c.error(b);a.addAlert("error","There was an error retrieving search results. TODO: better messages")},
g=function(c){a.submitting=!1;d.reload();b.path("/map/").search({}).search("m_zoom",8);c.geometry.location&&(b.search("m_center",c.geometry.location.toUrlValue()),b.search("m_selected",c.geometry.location.toUrlValue()));c.geometry.viewport&&b.search("m_bounds",c.geometry.viewport.toUrlValue())};a.$watch("selected",function(b){b&&a.submit()});a.submit=function(){if(a.selected){a.submitting=!0;a.autocompleting=0;var b=a.selected;b.reference&&e.getDetails(b.reference).then(function(a){g(a)},f)}else if(b=
a.lastQuery)a.submitting=!0,a.autocompleting=0,e.getPlacePredictions(b).then(function(a){e.getDetails(a[0].reference).then(function(a){g(a)},f)},f)}}])})();(function(){angular.module("hutmap").controller("MapConfigCtrl",["$scope","hutmapMapId","angulargmContainer","mapOptions","markerOptions",function(a,b,d,c,e){d=d.getMapPromise(b);var f;a.hutmapMapId=b;a.mapOptions=c;a.markerOptions=e;a.selectHut=function(b,c){f&&f.setOptions(e.huts);f=b;b.setOptions(e.selected);a.setSelectedHut(c)};d.then(function(a){var b={MSR_TOPO:new google.maps.ImageMapType({name:"MSR USGS",alt:"USGS topos from Microsoft Research",minZoom:1,maxZoom:15,tileSize:new google.maps.Size(256,
256),isPng:!1,getTileUrl:function(b,c){var d=a.getProjection(),e=Math.pow(2,c),f=new google.maps.Point(256*b.x/e,256*(b.y+1)/e),e=new google.maps.Point(256*(b.x+1)/e,256*b.y/e),f=d.fromPointToLatLng(f),d=d.fromPointToLatLng(e);return"http://msrmaps.com/ogcmap.ashx?version=1.1.1&request=GetMap&Layers=drg&Styles=default&SRS=EPSG:4326&BBOX="+[f.lng(),f.lat(),d.lng(),d.lat()].join()+"&width=256&height=256&format=image/jpeg"}}),ARC_GIS_USA:new google.maps.ImageMapType({name:"ArcGIS USA",alt:"ArcGIS USA Topos",

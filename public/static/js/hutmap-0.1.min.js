...
var g=!1,j=!1,f=!1;c.hasOwnProperty("gmCenter")&&(g=!0);c.hasOwnProperty("gmZoom")&&(j=!0);c.hasOwnProperty("gmBounds")&&(f=!0);e=function(){b(function(){(g||j||f)&&a.$apply(function(){if(g&&(a.gmCenter=d.center),j&&(a.gmZoom=d.zoom),f){var b=d.bounds;b&&(a.gmBounds=b)}})})};d.addMapListener("drag",e);d.addMapListener("zoom_changed",e);d.addMapListener("center_changed",e);d.addMapListener("bounds_changed",e);g&&a.$watch("gmCenter",function(a,b){a!==b&&!d.dragging&&a&&(d.center=a)},!0);j&&a.$watch("gmZoom",
function(a,b){null!=a&&!isNaN(a)&&a!==b&&(d.zoom=a)});f&&a.$watch("gmBounds",function(a,b){a!==b&&!d.dragging&&a&&(d.bounds=a)})}}}])})();
(function(){angular.module("AngularGM").directive("gmMarkers",["$log","$parse","$timeout","angulargmUtils",function(b,a,e,c){c.latLngEqual;var d=c.objToLatLng;return{restrict:"AE",priority:100,scope:{gmObjects:"&",gmGetLatLng:"&",gmGetMarkerOptions:"&",gmEvent:"&"},require:"^gmMap",link:function(b,c,f,k){if(!("gmObjects"in f))throw"gmObjects attribute required";if(!("gmGetLatLng"in f))throw"gmGetLatLng attribute required";var l={};angular.forEach(f,function(b,h){if(0===h.lastIndexOf("gmOn",0)){var c=
angular.lowercase(h.substring(4)),k=a(b);l[c]=k}});var h=function(a){var h={};angular.forEach(a,function(a){var m=b.gmGetLatLng({object:a}),c=d(m);if(null!=c){var p=b.gmGetMarkerOptions({object:a}),j=c.toUrlValue(k.precision);if(h[j]=a,!k.hasMarker(m.lat,m.lng)){j={};angular.extend(j,p,{position:c});k.addMarker(j);var f=k.getMarker(m.lat,m.lng);angular.forEach(l,function(h,m){k.addListener(f,m,function(){e(function(){h(b.$parent.$parent,{object:a,marker:f})})})})}}});var c=[];k.forEachMarker(function(a){a.getPosition().toUrlValue(k.precision)in
h||c.push(a)});angular.forEach(c,function(a){a=a.getPosition();k.removeMarker(a.lat(),a.lng())})};b.$watch("gmObjects().length",function(a,c){null!=a&&a!==c&&h(b.gmObjects())});b.$watch("gmObjects()",function(a,c){null!=a&&a!==c&&h(b.gmObjects())});b.$watch("gmEvent()",function(a,b){if(null!=a&&a!==b){var h=a.event,c=a.location,c=k.getMarker(c.lat(),c.lng());null!=c&&e(angular.bind(this,k.trigger,c,h))}});e(angular.bind(null,h,b.gmObjects()))}}}])})();
...
set:function(a){if(f(a.getSouthWest())||f(a.getNorthEast()))throw"bounds contains null or NaN";!j(this.bounds,a)&&this._map.fitBounds(a)}}});this._initDragListeners();a.$on("$destroy",angular.bind(this,this._destroy,h))})(b,a)}])})();/*
 MIT License, http://www.opensource.org/licenses/MIT
*/
...
var g=!1,j=!1,f=!1;c.hasOwnProperty("gmCenter")&&(g=!0);c.hasOwnProperty("gmZoom")&&(j=!0);c.hasOwnProperty("gmBounds")&&(f=!0);e=function(){b(function(){(g||j||f)&&a.$apply(function(){if(g&&(a.gmCenter=d.center),j&&(a.gmZoom=d.zoom),f){var b=d.bounds;b&&(a.gmBounds=b)}})})};d.addMapListener("drag",e);d.addMapListener("zoom_changed",e);d.addMapListener("center_changed",e);d.addMapListener("bounds_changed",e);g&&a.$watch("gmCenter",function(a,b){a!==b&&!d.dragging&&a&&(d.center=a)},!0);j&&a.$watch("gmZoom",
function(a,b){null!=a&&!isNaN(a)&&a!==b&&(d.zoom=a)});f&&a.$watch("gmBounds",function(a,b){a!==b&&!d.dragging&&a&&(d.bounds=a)})}}}])})();
(function(){angular.module("AngularGM").directive("gmMarkers",["$log","$parse","$timeout","angulargmUtils",function(b,a,e,c){c.latLngEqual;var d=c.objToLatLng;return{restrict:"AE",priority:100,scope:{gmObjects:"&",gmGetLatLng:"&",gmGetMarkerOptions:"&",gmEvents:"&"},require:"^gmMap",link:function(b,c,f,k){if(!("gmObjects"in f))throw"gmObjects attribute required";if(!("gmGetLatLng"in f))throw"gmGetLatLng attribute required";var l={};angular.forEach(f,function(b,h){if(0===h.lastIndexOf("gmOn",0)){var c=
angular.lowercase(h.substring(4)),d=a(b);l[c]=d}});var h=function(a){var h={};angular.forEach(a,function(a){var c=b.gmGetLatLng({object:a}),m=d(c);if(null!=m){var j=b.gmGetMarkerOptions({object:a}),p=m.toUrlValue(k.precision);if(h[p]=a,!k.hasMarker(c.lat,c.lng)){p={};angular.extend(p,j,{position:m});k.addMarker(p);var f=k.getMarker(c.lat,c.lng);angular.forEach(l,function(h,c){k.addListener(f,c,function(){e(function(){h(b.$parent.$parent,{object:a,marker:f})})})})}}});var c=[];k.forEachMarker(function(a){a.getPosition().toUrlValue(k.precision)in
h||c.push(a)});angular.forEach(c,function(a){a=a.getPosition();k.removeMarker(a.lat(),a.lng())});b.$emit("gmMarkersUpdated",f.gmObjects)};b.$watch("gmObjects().length",function(a,c){null!=a&&a!==c&&h(b.gmObjects())});b.$watch("gmObjects()",function(a,c){null!=a&&a!==c&&h(b.gmObjects())});b.$watch("gmEvents()",function(a,b){null!=a&&a!==b&&angular.forEach(a,function(a){var b=a.event;angular.forEach(a.locations,function(a){a=k.getMarker(a.lat(),a.lng());null!=a&&e(angular.bind(this,k.trigger,a,b))})})});
b.$on("gmMarkersRedraw",function(a,c){c===f.gmObjects&&(h(),h(b.gmObjects()))});e(angular.bind(null,h,b.gmObjects()))}}}])})();
(function(){angular.module("AngularGM").factory("angulargmContainer",["$q",function(b){var a={},e={};return{addMap:function(b,d){if(!(d instanceof google.maps.Map))throw"map not a google.maps.Map: "+d;if(b in a)throw"already contain map with id "+b;a[b]=d;b in e&&e[b].resolve(d)},getMap:function(b){return a[b]},getMapPromise:function(a){var d=e[a]||b.defer();return e[a]=d,d.promise},removeMap:function(b){b in a&&delete a[b];b in e&&delete e[b]},clear:function(){a={};e={}}}}])})();
(function(){angular.module("AngularGM").factory("angulargmUtils",[function(){function b(a,b){var c;if(a instanceof google.maps.LatLng&&b instanceof google.maps.LatLng){c=a.lat();var d=b.lat();if(c=1E-6>Math.abs(c-d))c=a.lng(),d=b.lng(),c=1E-6>Math.abs(c-d)}else c=!1;return c}return{latLngEqual:b,boundsEqual:function(a,e){if(!(a instanceof google.maps.LatLngBounds&&e instanceof google.maps.LatLngBounds))return!1;var c=a.getSouthWest(),d=e.getSouthWest(),g=a.getNorthEast(),j=e.getNorthEast();return b(c,
d)&&b(g,j)},latLngToObj:function(a){if(!(a instanceof google.maps.LatLng))throw"latLng not a google.maps.LatLng";return{lat:a.lat(),lng:a.lng()}},objToLatLng:function(a){if(null!=a){var b=a.lat;a=a.lng;if(!(null==b||null==a||isNaN(b)||isNaN(a)))return new google.maps.LatLng(b,a)}return null},hasNaN:function(a){if(!(a instanceof google.maps.LatLng))throw"latLng must be a google.maps.LatLng";var b=null==a.lat()||null==a.lng();a=isNaN(a.lat())||isNaN(a.lng());return b||a}}}])})();
(function(){angular.module("AngularGM").controller("angulargmMapController",["$scope","$element","angulargmUtils","angulargmDefaults","angulargmContainer",function(b,a,e,c,d){var g=e.latLngEqual,j=e.boundsEqual,f=e.hasNaN;this._getConfig=function(a,b){var h={};return angular.extend(h,b.mapOptions,a.gmMapOptions()),h};this._createMap=function(a,b,h,c){var d=c.getMap(a);if(d)throw"A map with id "+a+" already exists. You must use different ids for each instance of the angulargm directive.";return d=
new google.maps.Map(b[0],h),c.addMap(a,d),d};this._initDragListeners=function(){var a=this;this.addMapListener("dragstart",function(){a.dragging=!0});this.addMapListener("idle",function(){a.dragging=!1});this.addMapListener("drag",function(){a.dragging=!0})};this._destroy=function(a){d.removeMap(a)};this.addMapListener=function(a,b){google.maps.event.addListener(this._map,a,b)};this.addMapListenerOnce=function(a,b){google.maps.event.addListenerOnce(this._map,a,b)};this.addListener=function(a,b,h){google.maps.event.addListener(a,
b,h)};this.addListenerOnce=function(a,b,h){google.maps.event.addListenerOnce(a,b,h)};this.mapTrigger=function(a){google.maps.event.trigger(this._map,a)};this.trigger=function(a,b){google.maps.event.trigger(a,b)};this.addMarker=function(a){var b={};if(angular.extend(b,a),!(b.position instanceof google.maps.LatLng))throw"markerOptions did not contain a position";a=new google.maps.Marker(b);b=a.getPosition();if(this.hasMarker(b.lat(),b.lng()))return!1;b=b.toUrlValue(this.precision);return this._markers[b]=
a,a.setMap(this._map),!0};this.hasMarker=function(a,b){return this.getMarker(a,b)instanceof google.maps.Marker};this.getMarker=function(a,b){if(null==a||null==b)throw"lat or lng was null";var h=(new google.maps.LatLng(a,b)).toUrlValue(this.precision);return h in this._markers?this._markers[h]:null};this.removeMarker=function(a,b){if(null==a||null==b)throw"lat or lng was null";var h=!1,c=(new google.maps.LatLng(a,b)).toUrlValue(this.precision),d=this._markers[c];return d&&(d.setMap(null),h=!0),this._markers[c]=
null,delete this._markers[c],h};this.fitToMarkers=function(){var a=new google.maps.LatLngBounds;this.forEachMarker(function(b){a.extend(b.getPosition())});this.bounds=a};this.forEachMarker=function(a){if(null==a)throw"fn was null or undefined";angular.forEach(this._markers,function(b){null!=b&&a(b)})};angular.bind(this,function(a,b){var h=a.gmMapId();if(!h)throw"angulargm must have non-empty gmMapId attribute";var m=b.find("[id]");m.attr("id",h);var e=this._getConfig(a,c);this._map=this._createMap(h,
m,e,d);this._markers={};this.dragging=!1;Object.defineProperties(this,{precision:{value:3,writeable:!1},center:{configurable:!0,get:function(){return this._map.getCenter()},set:function(a){if(f(a))throw"center contains null or NaN";!g(this.center,a)&&this._map.panTo(a)}},zoom:{configurable:!0,get:function(){return this._map.getZoom()},set:function(a){if(null==a||isNaN(a))throw"zoom was null or NaN";this.zoom!==a&&this._map.setZoom(a)}},bounds:{configurable:!0,get:function(){return this._map.getBounds()},
set:function(a){if(f(a.getSouthWest())||f(a.getNorthEast()))throw"bounds contains null or NaN";!j(this.bounds,a)&&this._map.fitBounds(a)}}});this._initDragListeners();a.$on("$destroy",angular.bind(this,this._destroy,h))})(b,a)}])})();(function(){function b(a,b){var c=this,d=new google.maps.OverlayView;d.onAdd=function(){c.init_(a,b)};d.draw=function(){};d.onRemove=function(){};d.setMap(a);this.prjov_=d}var a=function(a){switch(a){case "thin":a="2px";break;case "medium":a="4px";break;case "thick":a="6px";break}return a},e=function(b){var c,d={};if(document.defaultView&&document.defaultView.getComputedStyle){if(c=b.ownerDocument.defaultView.getComputedStyle(b,""))return d.top=parseInt(c.borderTopWidth,10)||0,d.bottom=parseInt(c.borderBottomWidth,
...
!0};b.prototype.onMouseMove_=function(a){this.mousePosn_=j(a);if(this.dragging_){this.endPt_=this.getMousePoint_(a);a=Math.min(this.startPt_.x,this.endPt_.x);var b=Math.min(this.startPt_.y,this.endPt_.y),d=Math.abs(this.startPt_.x-this.endPt_.x),c=Math.abs(this.startPt_.y-this.endPt_.y),e=Math.max(0,d-(this.boxBorderWidths_.left+this.boxBorderWidths_.right)),g=Math.max(0,c-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom));this.veilDiv_[0].style.top="0px";this.veilDiv_[0].style.left="0px";
...
!1;if(this.dragging_)if(this.getMousePoint_(a).x===this.startPt_.x&&this.getMousePoint_(a).y===this.startPt_.y)this.onKeyUp_(a);else{var c=Math.min(this.startPt_.x,this.endPt_.x),e=Math.min(this.startPt_.y,this.endPt_.y);b=Math.abs(this.startPt_.x-this.endPt_.x);var j=Math.abs(this.startPt_.y-this.endPt_.y),c=c+this.borderWidths_.left,e=e+this.borderWidths_.top,f=this.prjov_.getProjection(),j=f.fromContainerPixelToLatLng(new google.maps.Point(c,e+j)),e=f.fromContainerPixelToLatLng(new google.maps.Point(c+
b,e)),c=new google.maps.LatLngBounds(j,e);this.noZoom_?this.boxDiv_.style.display="none":(b=this.map_.getZoom(),this.map_.fitBounds(c),this.map_.getZoom()<b&&this.map_.setZoom(b),j=f.fromLatLngToContainerPixel(j),f=f.fromLatLngToContainerPixel(e),j.x-=this.borderWidths_.left,j.y-=this.borderWidths_.top,f.x-=this.borderWidths_.left,f.y-=this.borderWidths_.top,this.boxDiv_.style.left=j.x+"px",this.boxDiv_.style.top=f.y+"px",this.boxDiv_.style.width=Math.abs(f.x-j.x)-(this.boxBorderWidths_.left+this.boxBorderWidths_.right)+
"px",this.boxDiv_.style.height=Math.abs(f.y-j.y)-(this.boxBorderWidths_.top+this.boxBorderWidths_.bottom)+"px",setTimeout(function(){d.boxDiv_.style.display="none"},1E3));this.dragging_=!1;this.onMouseMove_(a);google.maps.event.trigger(this,"dragend",c);if(!this.isHotKeyDown_(a))this.onKeyUp_(a)}};b.prototype.onKeyUp_=function(){var a,b,d,c,e;b=null;if(this.map_&&this.hotKeyDown_){this.hotKeyDown_=!1;this.dragging_&&(this.boxDiv_.style.display="none",this.dragging_=!1,a=Math.min(this.startPt_.x,this.endPt_.x),
...
angular.module("ui.bootstrap.transition",[]).factory("$transition",["$q","$timeout","$rootScope",function(b,a,e){function c(a){for(var b in a)if(void 0!==g.style[b])return a[b]}var d=function(c,f,g){g=g||{};var l=b.defer(),h=d[g.animation?"animationEndEventName":"transitionEndEventName"],m=function(){e.$apply(function(){c.unbind(h,m);l.resolve(c)})};h&&c.bind(h,m);a(function(){angular.isString(f)?c.addClass(f):angular.isFunction(f)?f(c):angular.isObject(f)&&c.css(f);h||l.resolve(c)});l.promise.cancel=
function(){h&&c.unbind(h,m);l.reject("Transition cancelled")};return l.promise},g=document.createElement("trans");d.transitionEndEventName=c({WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",transition:"transitionend"});d.animationEndEventName=c({WebkitTransition:"webkitAnimationEnd",MozTransition:"animationend",OTransition:"oAnimationEnd",transition:"animationend"});return d}]);
angular.module("ui.bootstrap.collapse",["ui.bootstrap.transition"]).directive("collapse",["$transition",function(b){var a=function(a,b,d){b.removeClass("collapse");b.css({height:d});b.addClass("collapse")};return{link:function(e,c,d){var g,j=!0;e.$watch(function(){return c[0].scrollHeight},function(){0!==c[0].scrollHeight&&(g||(j?a(e,c,c[0].scrollHeight+"px"):a(e,c,"auto")))});e.$watch(d.collapse,function(b){b?(g=!0,j?(j=!1,a(e,c,0)):(a(e,c,c[0].scrollHeight+"px"),k({height:"0"}))):(j?(j=!1,g||a(e,
...
function(a){this.heading=a}}],link:function(a,e,c,d){var g,j;d.addGroup(a);a.isOpen=!1;c.isOpen&&(g=b(c.isOpen),j=g.assign,a.$watch(function(){return g(a.$parent)},function(b){a.isOpen=b}),a.isOpen=g?g(a.$parent):!1);a.$watch("isOpen",function(b){b&&d.closeOthers(a);j&&j(a.$parent,b)})}}}]).directive("accordionHeading",function(){return{restrict:"E",transclude:!0,template:"",replace:!0,require:"^accordionGroup",compile:function(b,a,e){return function(a,b,g,j){j.setHeading(e(a,function(){}))}}}}).directive("accordionTransclude",
...
angular.module("ui.bootstrap.buttons",[]).constant("buttonConfig",{activeClass:"active",toggleEvent:"click"}).directive("btnRadio",["buttonConfig",function(b){var a=b.activeClass||"active",e=b.toggleEvent||"click";return{require:"ngModel",link:function(b,d,g,j){var f=b.$eval(g.btnRadio);b.$watch(function(){return j.$modelValue},function(b){angular.equals(b,f)?d.addClass(a):d.removeClass(a)});d.bind(e,function(){d.hasClass(a)||b.$apply(function(){j.$setViewValue(f)})})}}}]).directive("btnCheckbox",
["buttonConfig",function(b){var a=b.activeClass||"active",e=b.toggleEvent||"click";return{require:"ngModel",link:function(b,d,g,j){var f=b.$eval(g.btnCheckboxTrue),k=b.$eval(g.btnCheckboxFalse),f=angular.isDefined(f)?f:!0,k=angular.isDefined(k)?k:!1;b.$watch(function(){return j.$modelValue},function(b){angular.equals(b,f)?d.addClass(a):d.removeClass(a)});d.bind(e,function(){b.$apply(function(){j.$setViewValue(d.hasClass(a)?k:f)})})}}}]);
angular.module("ui.bootstrap.carousel",["ui.bootstrap.transition"]).controller("CarouselController",["$scope","$timeout","$transition","$q",function(b,a,e){function c(){function d(){k?(b.next(),c()):b.pause()}f&&a.cancel(f);var e=+b.interval;!isNaN(e)&&0<=e&&(f=a(d,e))}var d=this,g=d.slides=[],j=-1,f,k;d.currentSlide=null;d.select=function(f,h){function k(){if(d.currentSlide&&angular.isString(h)&&!b.noTransition&&f.$element){f.$element.addClass(h);f.$element.attr("offsetWidth",f.$element[0].offsetWidth);
angular.forEach(g,function(a){angular.extend(a,{direction:"",entering:!1,leaving:!1,active:!1})});angular.extend(f,{direction:h,active:!0,entering:!0});angular.extend(d.currentSlide||{},{direction:h,leaving:!0});b.$currentTransition=e(f.$element,{});var a=f,m=d.currentSlide;b.$currentTransition.then(function(){q(a,m)},function(){q(a,m)})}else q(f,d.currentSlide);d.currentSlide=f;j=p;c()}function q(a,d){angular.extend(a,{direction:"",active:!0,leaving:!1,entering:!1});angular.extend(d||{},{direction:"",
active:!1,leaving:!1,entering:!1});b.$currentTransition=null}var p=g.indexOf(f);void 0===h&&(h=p>j?"next":"prev");f&&f!==d.currentSlide&&(b.$currentTransition?(b.$currentTransition.cancel(),a(k)):k())};d.indexOfSlide=function(a){return g.indexOf(a)};b.next=function(){return d.select(g[(j+1)%g.length],"next")};b.prev=function(){return d.select(g[0>j-1?g.length-1:j-1],"prev")};b.select=function(a){d.select(a)};b.isActive=function(a){return d.currentSlide===a};b.slides=function(){return g};b.$watch("interval",
...
c.$scope.$apply()}}var r=d.find("body");p.prototype.isOpen=function(){return this._open};p.prototype.open=function(a,b){var d=this,c=this.options;a&&(c.templateUrl=a);b&&(c.controller=b);if(!c.template&&!c.templateUrl)throw Error("Dialog.open expected template or templateUrl, neither found. Use options or open method to specify them.");this._loadResolves().then(function(a){var b=a.$scope=d.$scope=a.$scope?a.$scope:j.$new();d.modalEl.html(a.$template);d.options.controller&&(a=f(d.options.controller,
...
e=this._getFadingElements();r.removeClass(c.options.dialogOpenClass);if(0<e.length)for(var f=e.length-1;0<=f;f--)h(e[f],b).then(d);else this._onCloseComplete(a)};p.prototype._getFadingElements=function(){var a=[];this.options.dialogFade&&a.push(this.modalEl);this.options.backdropFade&&a.push(this.backdropEl);return a};p.prototype._bindEvents=function(){this.options.keyboard&&r.bind("keydown",this.handledEscapeKey);this.options.backdrop&&this.options.backdropClick&&this.backdropEl.bind("click",this.handleBackDropClick)};
...
angular.module("ui.bootstrap.modal",["ui.bootstrap.dialog"]).directive("modal",["$parse","$dialog",function(b,a){return{restrict:"EA",terminal:!0,link:function(e,c,d){var g=angular.extend({},e.$eval(d.uiOptions||d.bsOptions||d.options)),j=d.modal||d.show,f,g=angular.extend(g,{template:c.html(),resolve:{$scope:function(){return e}}}),k=a.dialog(g);c.remove();f=d.close?function(){b(d.close)(e)}:function(){angular.isFunction(b(j).assign)&&b(j).assign(e,!1)};e.$watch(j,function(a){a?k.open().then(function(){f()}):
k.isOpen()&&k.close()})}}}]);
...
a.$eval(c.boundaryLinks):b.boundaryLinks,j=angular.isDefined(c.directionLinks)?a.$eval(c.directionLinks):b.directionLinks,f=angular.isDefined(c.firstText)?c.firstText:b.firstText,k=angular.isDefined(c.previousText)?c.previousText:b.previousText,l=angular.isDefined(c.nextText)?c.nextText:b.nextText,h=angular.isDefined(c.lastText)?c.lastText:b.lastText;a.$watch("numPages + currentPage + maxSize",function(){a.pages=[];var b=1,c=a.numPages;a.maxSize&&a.maxSize<a.numPages&&(b=Math.max(a.currentPage-Math.floor(a.maxSize/
2),1),c=b+a.maxSize-1,c>a.numPages&&(c=a.numPages,b=c-a.maxSize+1));for(;b<=c;b++){var e=d(b,b,a.isActive(b),!1);a.pages.push(e)}j&&(c=d(a.currentPage-1,k,!1,a.noPrevious()),a.pages.unshift(c),c=d(a.currentPage+1,l,!1,a.noNext()),a.pages.push(c));g&&(c=d(1,f,!1,a.noPrevious()),a.pages.unshift(c),c=d(a.numPages,h,!1,a.noNext()),a.pages.push(c));a.currentPage>a.numPages&&a.selectPage(a.numPages)});a.noPrevious=function(){return 1===a.currentPage};a.noNext=function(){return a.currentPage===a.numPages};
...
angular.module("ui.bootstrap.tooltip",[]).provider("$tooltip",function(){var b={placement:"top",animation:!0,popupDelay:0},a={};this.options=function(b){angular.extend(a,b)};this.$get=["$window","$compile","$timeout","$parse","$document",function(e,c,d,g,j){return function(f,k,l,h){var m=angular.extend({},b,a),q;q=f.replace(/[A-Z]/g,function(a,b){return(b?"-":"")+a.toLowerCase()});var p="<"+q+'-popup title="{{tt_title}}" content="{{tt_content}}" placement="{{tt_placement}}" animation="tt_animation()" is-open="tt_isOpen"></'+
q+"-popup>";return{restrict:"EA",scope:!0,link:function(a,b,q){function w(){a.tt_popupDelay?z=d(x,a.tt_popupDelay):a.$apply(x)}function x(){var c,f,g,h,k,l;if(a.tt_content){u&&d.cancel(u);s.css({top:0,left:0,display:"block"});m.appendToBody?(v=v||j.find("body"),v.append(s)):b.after(s);f=b;h=f[0].getBoundingClientRect();c=f.prop("offsetWidth");f=f.prop("offsetHeight");g=h.top+e.pageYOffset;h=h.left+e.pageXOffset;k=s.prop("offsetWidth");l=s.prop("offsetHeight");switch(a.tt_placement){case "right":c=
{top:g+f/2-l/2+"px",left:h+c+"px"};break;case "bottom":c={top:g+f+"px",left:h+c/2-k/2+"px"};break;case "left":c={top:g+f/2-l/2+"px",left:h-k+"px"};break;default:c={top:g-l+"px",left:h+c/2-k/2+"px"}}s.css(c);a.tt_isOpen=!0}}function y(){a.tt_isOpen=!1;d.cancel(z);angular.isDefined(a.tt_animation)&&a.tt_animation()?u=d(function(){s.remove()},500):s.remove()}var s=c(p)(a),u,z,v;q.$observe(f,function(b){a.tt_content=b});q.$observe(k+"Title",function(b){a.tt_title=b});q.$observe(k+"Placement",function(b){a.tt_placement=
angular.isDefined(b)?b:m.placement});q.$observe(k+"Animation",function(b){a.tt_animation=angular.isDefined(b)?g(b):function(){return m.animation}});q.$observe(k+"PopupDelay",function(b){b=parseInt(b,10);a.tt_popupDelay=!isNaN(b)?b:m.popupDelay});a.tt_isOpen=!1;angular.isDefined(h)?(b.bind(l,function(){w()}),b.bind(h,function(){a.$apply(y)})):b.bind(l,function(){a.tt_isOpen?a.$apply(y):w()})}}}}]}).directive("tooltipPopup",function(){return{restrict:"E",replace:!0,scope:{content:"@",placement:"@",
...
replace:!0}}).directive("pane",["$parse",function(b){return{require:"^tabs",restrict:"EA",transclude:!0,scope:{heading:"@"},link:function(a,e,c,d){var g,j;a.selected=!1;c.active&&(g=b(c.active),j=g.assign,a.$watch(function(){return g(a.$parent)},function(b){a.selected=b}),a.selected=g?g(a.$parent):!1);a.$watch("selected",function(b){b&&d.select(a);j&&j(a.$parent,b)});d.addPane(a);a.$on("$destroy",function(){d.removePane(a)})},templateUrl:"template/tabs/pane.html",replace:!0}}]);
...
function(b,a,e,c,d){var g=[9,13,27,38,40];return{require:"ngModel",link:function(j,f,k,l){var h,m=j.$eval(k.typeaheadMinLength)||1,q=d.parse(k.typeahead),p=!1!==j.$eval(k.typeaheadEditable),r=a(k.typeaheadLoading).assign||angular.noop,n=j.$new();j.$on("$destroy",function(){n.$destroy()});var t=function(){n.matches=[];n.activeIdx=-1};t();n.query=void 0;l.$parsers.push(function(a){t();if(h)return a;if(a&&a.length>=m){var b={$viewValue:a};r(j,!0);e.when(q.source(n,b)).then(function(c){if(a===l.$viewValue){if(0<
c.length){n.activeIdx=0;for(var d=n.matches.length=0;d<c.length;d++)b[q.itemName]=c[d],n.matches.push({label:q.viewMapper(n,b),model:c[d]});n.query=a}else t();r(j,!1)}},function(){t();r(j,!1)})}return p?a:void 0});l.$render=function(){var a={};a[q.itemName]=h||l.$viewValue;f.val(q.viewMapper(n,a)||l.$viewValue);h=void 0};n.select=function(a){var b={};b[q.itemName]=h=n.matches[a].model;l.$setViewValue(q.modelMapper(n,b));l.$render()};f.bind("keydown",function(a){0===n.matches.length||-1===g.indexOf(a.which)||
...
a}});(function(){angular.module("hutmap",["hutmapServices","hutmapFilters","AngularGM","ngResource","ui.bootstrap"])})();(function(){angular.module("hutmapServices",[]).factory("Huts",["$http",function(b){return{query:function(a,e,c){b.get("/huts/api/v1/hutsearch/",{params:a}).success(e).error(c)}}}]).factory("HutDB",["$http","$filter",function(b,a){var e={},c=a("filter"),d;b.get("/static/data/huts.json").success(function(a){d=a});e.query=function(a){var b=a.bounds;a=c(d.objects,function(a){return b?(a=new google.maps.LatLng(a.location.coordinates[1],a.location.coordinates[0]),b.contains(a)):!0});return{meta:{total_count:a.length},
objects:a}};return e}]).factory("Places",["$q",function(b){function a(a,b,c){c==google.maps.places.PlacesServiceStatus.OK?a.resolve(b):a.reject(c)}var e=angular.element('<div id="google-attributions"></div>'),c=new google.maps.places.PlacesService(e[0]),d=new google.maps.places.AutocompleteService;return{getDetails:function(d){var e=b.defer();c.getDetails({reference:d},angular.bind(this,a,e));return e.promise},textSearch:function(d){var e=b.defer();c.textSearch(d,angular.bind(this,a,e));return e.promise},
getPlacePredictions:function(c){var e=b.defer();d.getPlacePredictions({input:c},angular.bind(this,a,e));return e.promise}}}]).factory("utils",[function(){return{latLngFromUrlValue:function(b){b=b.split(",");return new google.maps.LatLng(b[0],b[1])},boundsFromUrlValue:function(b){b=b.split(",");return new google.maps.LatLngBounds(new google.maps.LatLng(b[0],b[1]),new google.maps.LatLng(b[2],b[3]))}}}])})();(function(){angular.module("hutmap").config(["$routeProvider","$locationProvider",function(b,a){b.when("/",{templateUrl:"/partials/home.html",activetab:"home"}).when("/map/",{templateUrl:"/partials/map.html",activetab:"map",reloadOnSearch:!1}).when("/about/",{templateUrl:"/partials/about.html",activetab:"about"});a.html5Mode(!0)}]).constant("hutmapMapId","map_canvas").value("mapOptions",{zoom:8,center:new google.maps.LatLng(46.87916,-120),mapTypeId:google.maps.MapTypeId.TERRAIN,streetViewControl:!1}).value("markerOptions",
...
"There was an error retrieving search results. TODO: better messages")},j=function(c){b.submitting=!1;e.reload();a.path("/map/").search({}).search("m_zoom",8);c.geometry.location&&(a.search("m_center",c.geometry.location.toUrlValue()),a.search("m_selected",c.geometry.location.toUrlValue()));c.geometry.viewport&&a.search("m_bounds",c.geometry.viewport.toUrlValue())};b.$watch("selected",function(a){a&&b.submit()});b.submit=function(){if(b.selected){b.submitting=!0;b.autocompleting=0;var a=b.selected;
a.reference&&d.getDetails(a.reference).then(function(a){j(a)},g)}else if(a=b.lastQuery)b.submitting=!0,b.autocompleting=0,d.getPlacePredictions(a).then(function(a){d.getDetails(a[0].reference).then(function(a){j(a)},g)},g)}}])})();(function(){angular.module("hutmap").controller("FilterCtrl",["$scope",function(b){b.season={winter:!0,summer:!0};b.shelterType={"emergency shelters":{include:!1,keywords:["Emergency Shelter","Refuge"]},"fire lookouts":{include:!0,keywords:["Fire Lookout"]},"huts & yurts":{include:!0,keywords:["Hut","Yurt","Chickee","Lean-to","Wall Tent"]},compounds:{include:!0,keywords:"Compound;Hostel;Tea House;Lodge;Chalet;Ranch".split(";")}};b.filter=function(){b.incLoading();var a={},e,c=[];angular.forEach(b.shelterType,
function(a){a.include&&(c=c.concat(a.keywords))});e=c;angular.forEach(b.huts,function(c){var g;g=b.season;g=!g.winter&&!g.summer?!0:g.winter&&c.open_winter||g.summer&&c.open_summer;if(g){var j=!1;angular.forEach(e,function(a){~c.types.indexOf(a)&&(j=!0)});g=j}g&&(a[c.id]=c)});b.setFilteredHuts(a);b.$broadcast("gmMarkersRedraw","huts");b.decLoading()};b.$watch("huts",function(){b.filter()})}])})();(function(){angular.module("hutmap").controller("MapConfigCtrl",["$scope","$http","hutmapMapId","angulargmContainer","mapOptions","markerOptions",function(b,a,e,c,d,g){a=c.getMapPromise(e);var j,f;b.hutmapMapId=e;b.mapOptions=d;b.markerOptions=g;b.getMarkerOptions=function(a){var c={title:a.name};return b.filteredHuts&&a.id in b.filteredHuts?angular.extend(c,b.markerOptions.filteredHuts):angular.extend(c,b.markerOptions.huts)};b.selectHut=function(a,c){if(j){var d=angular.extend({},g.huts,{icon:f});
j.setOptions(d)}j=a;f=a.getIcon();a.setOptions(g.selected);b.setSelectedHut(c)};a.then(function(a){var b={MSR_TOPO:new google.maps.ImageMapType({name:"MSR USGS",alt:"USGS topos from Microsoft Research",minZoom:1,maxZoom:15,tileSize:new google.maps.Size(256,256),isPng:!1,getTileUrl:function(b,c){var d=a.getProjection(),e=Math.pow(2,c),f=new google.maps.Point(256*b.x/e,256*(b.y+1)/e),e=new google.maps.Point(256*(b.x+1)/e,256*b.y/e),f=d.fromPointToLatLng(f),d=d.fromPointToLatLng(e);return"http://msrmaps.com/ogcmap.ashx?version=1.1.1&request=GetMap&Layers=drg&Styles=default&SRS=EPSG:4326&BBOX="+
